...
namespace ReaderMobileManagement
{
	...
	public class ReaderEventMobileController
	{
		protected static ReaderEventMobileController instance;
		...
		private ReaderEventMobileController()
		{
			// Debug
		...
		public static ReaderEventMobileController GetInstance()
		{
			try
			{
				if (instance == null)
				{
					instance = new ReaderEventMobileController();
				}
			}
			catch(Exception ex)
			{
        ...
        //        {
        //            ((MonitorMobileThread) readerThreads[j]).StartComPortReading();	
        //            threadStarted ++;
        //        }
        ...
        //        {
        //            MonitorMobileThread instance = (MonitorMobileThread) readerThreads[j];
        ...
        //        for(int j=0; j<readers.Count; j++)
        //        {
        //            ((MonitorMobileThread) readerThreads[j]).StopComPortReading();
        //            threadStopped ++;
        //        }
        ...
        //        for(int j=0; j<readers.Count; j++)
        //        {
        //            readerThreads.Add(new MonitorMobileThread(readers[j], j+1));	
        //        }
        //    }
        //    catch(Exception ex)
        //    {
        ...
        //    try
        //    {
        //        foreach(MonitorMobileThread rt in readerThreads)
        //        {
        ...
        //public void SendMonitorNotification(ReaderTO currentReader, int currentAntennaNum, UInt32 currentTagID)
        //{
        //    try
        //    {
		...
		public void RestartReading(DownloadMobileManager mgrInstance)
		{
			try
			{
				...
				mgrInstance = null;
				GC.Collect();
				DownloadMobileManager downloadMgr = DownloadMobileManager.GetInstance();
			...
			try
			{
				while(doListening)
				{
					if (NeedRestart)
					{
						...
						DownloadMobileManager mgr = DownloadMobileManager.GetInstance();
						mgr.AbortReading();
