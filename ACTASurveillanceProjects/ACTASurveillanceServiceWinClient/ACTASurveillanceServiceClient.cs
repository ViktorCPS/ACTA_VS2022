...
namespace ACTASurveillanceServiceWinClient
{
      /// <summary>
	...
	/// </summary>
    public partial class ACTASurveillanceServiceClient : Form
    {

        private static ACTASurveillanceServiceClient _instance = null;
        ...
        ServiceReference1.ACTASurveillanceServiceClient client;

        CardOwnerTO lastCardOwnerTO = null;
        ...
        public ACTASurveillanceServiceClient(string gateID)
        {
            InitializeComponent();
        ...
        public static ACTASurveillanceServiceClient Instance 
		{
			get 
			{
				if (_instance == null) 
				{
                    _instance = new ACTASurveillanceServiceClient();
				}
				return _instance;
			}
		}
		...
		private void Monitor_Load(object sender, System.EventArgs e)
		{
            ...
            client = new ACTASurveillanceServiceWinClient.ServiceReference1.ACTASurveillanceServiceClient();
		...
		private void InitializeComponent()
		{
            ...
            this.Name = "ACTASurveillanceServiceClient";
        ...
        private void timer3_Tick(object sender, EventArgs e)
        {
            ...
            {               
                ...
                if (lastCardOwnerTO == null || cardOwnerTO.antennaNum != lastCardOwnerTO.antennaNum || cardOwnerTO.cardSerialNumber != lastCardOwnerTO.cardSerialNumber || cardOwnerTO.reader.ReaderID != lastCardOwnerTO.reader.ReaderID)
                {
                    CardOwner owner = new CardOwner(cardOwnerTO.reader, cardOwnerTO.cardSerialNumber, cardOwnerTO.antennaNum, cardOwnerTO.entrancePermitted, cardOwnerTO.eventTime);
                    owner.employee = cardOwnerTO.employee; ;
                    cardOwners.Enqueue(owner);
                }

            }

            lastCardOwnerTO = cardOwnerTO;
        }
