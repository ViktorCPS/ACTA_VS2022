...
{
    /// <summary>
    /// Summary description for MySQLEmployeeImageFileDAO.
    /// </summary>
    public class MySQLEmployeeImageFileDAO : EmployeeImageFileDAO
    {
        ...
        public MySQLEmployeeImageFileDAO()
		{
			conn = MySQLDAOFactory.getConnection();
            database = Constants.GetDatabaseString + "_files.";
		}
        public MySQLEmployeeImageFileDAO(MySqlConnection mySqlConnection)
        {
            ...
            try
            {
                ...
                if (table.Rows.Count > 0)
                {
                    foreach (DataRow row in table.Rows)
                    {
                        ...
                        {
                            employeeImageFileTO.ModifiedTime = DateTime.Parse(row["modified_time"].ToString());
                        }                        
