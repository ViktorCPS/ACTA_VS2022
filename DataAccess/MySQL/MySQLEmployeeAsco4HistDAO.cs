...
{
  public  class MySQLEmployeeAsco4HistDAO:EmployeeAsco4HistDAO
    {
      MySqlConnection conn = null;
        ...
        public MySQLEmployeeAsco4HistDAO()
        {
            conn = MySQLDAOFactory.getConnection();
            DAOController.GetInstance();
        }

        public MySQLEmployeeAsco4HistDAO(MySqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
        }
