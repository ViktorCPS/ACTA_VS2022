...
{
	/// <summary>
	/// Summary description for MySQLApplMenuItemDAO.
	/// </summary>
	public class MySQLApplMenuItemDAO : ApplMenuItemDAO
	{
		...
		public MySQLApplMenuItemDAO()
		{
			conn = MySQLDAOFactory.getConnection();
		}
        public MySQLApplMenuItemDAO(MySqlConnection mySqlConnection)
        {
		...
		public ApplMenuItemTO find(string applMenuItemID)
		{
			...
			try
			{
				MySqlCommand cmd = new MySqlCommand( "SELECT * FROM appl_menu_items WHERE appl_menu_item_id = N'" + applMenuItemID.Trim() + "'", conn );
		...
		public List<ApplMenuItemTO> getApplMenuItems(ApplMenuItemTO menuItemTO)
		{
			...
			try
			{
                    ...
                    (!menuItemTO.LangCode.Trim().Equals("")) || (!menuItemTO.Position.Trim().Equals("")))
				{
					...
					{
                        sb.Append(" UPPER(appl_menu_item_id) LIKE N'" + menuItemTO.ApplMenuItemID.ToUpper().Trim() + "' AND");
					}
