...
{
	/// <summary>
	/// Summary description for MySQLAccessGroupXGateDAO.
	/// </summary>
	public class MySQLAccessGroupXGateDAO : AccessGroupXGateDAO
	{
		...
		public MySQLAccessGroupXGateDAO()
		{
			conn = MySQLDAOFactory.getConnection();
		}
        public MySQLAccessGroupXGateDAO(MySqlConnection mySqlConnection)
        {
		...
		public AccessGroupXGateTO find(string accessGroupID, string gateID)
		{
			...
			try
			{
				MySqlCommand cmd = new MySqlCommand("SELECT access_group_id, gate_id, gate_timeacess_profile, reader_access_group_ord_num FROM employee_groups_access_control_x_gates "
