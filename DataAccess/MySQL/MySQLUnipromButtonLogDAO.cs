...
{
   public class MySQLUnipromButtonLogDAO:UnipromButtonLogDAO
    {
         MySqlConnection conn = null;
		MySqlTransaction _sqlTrans = null;
		protected string dateTimeformat = "";

		public MySQLUnipromButtonLogDAO()
		{
       ...
       public MySQLUnipromButtonLogDAO(MySqlConnection mySqlConnection)
        {
