...
{
    public class MySQLEmployeePositionXRiskDAO : EmployeePositionXRiskDAO
    {
        ...
        public MySQLEmployeePositionXRiskDAO()
        {
        ...
        public MySQLEmployeePositionXRiskDAO(MySqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
