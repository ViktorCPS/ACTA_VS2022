...
{
    public class MySQLApplUserLoginRFIDDAO : ApplUserLoginRFIDDAO
    {
        ...
        public MySQLApplUserLoginRFIDDAO()
        {
            conn = MySQLDAOFactory.getConnection();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
        }
        public MySQLApplUserLoginRFIDDAO(MySqlConnection mySqlConnection)
        {
        ...
        public bool update(ApplUserLoginRFIDTO rfidTO, bool doCommit)
        {
            ...
            try
            {
                ...
                sbUpdate.Append("created_time = NOW() ");
