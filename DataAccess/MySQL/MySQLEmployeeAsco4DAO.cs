...
{
    public class MySQLEmployeeAsco4DAO:EmployeeAsco4DAO
    {
		...
		public MySQLEmployeeAsco4DAO()
		{
			conn = MySQLDAOFactory.getConnection();
			DAOController.GetInstance();
		}
        public MySQLEmployeeAsco4DAO(MySqlConnection mySqlConnection)
        {
        ...
        public List<EmployeeAsco4TO> getEmployeesAsco(EmployeeAsco4TO emplTO)
        {
            ...
            try
            {
                    ...
                    || (!emplTO.NVarcharValue9.Trim().Equals("")) || (!emplTO.NVarcharValue10.Trim().Equals("")))
                {
                    ...
                    {
                        sb.Append(" datetime_value_1 = CONVERT('" + emplTO.DatetimeValue1.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!emplTO.DatetimeValue2.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_2 = CONVERT('" + emplTO.DatetimeValue2.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!emplTO.DatetimeValue3.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_3 = CONVERT('" + emplTO.DatetimeValue3.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!emplTO.DatetimeValue4.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_4 = CONVERT('" + emplTO.DatetimeValue4.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!emplTO.DatetimeValue5.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_5 = CONVERT('" + emplTO.DatetimeValue5.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!emplTO.DatetimeValue6.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_6 = CONVERT('" + emplTO.DatetimeValue6.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!emplTO.DatetimeValue7.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_7 = CONVERT('" + emplTO.DatetimeValue7.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!emplTO.DatetimeValue8.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_8 = CONVERT('" + emplTO.DatetimeValue8.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!emplTO.DatetimeValue9.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_9 = CONVERT('" + emplTO.DatetimeValue9.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!emplTO.DatetimeValue10.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_10 = CONVERT('" + emplTO.DatetimeValue10.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
