...
{
    public class MySQLEmployeeCounterValueHistDAO : EmployeeCounterValueHistDAO
    {
        ...
        public MySQLEmployeeCounterValueHistDAO()
		{
			conn = MySQLDAOFactory.getConnection();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
		}
        public MySQLEmployeeCounterValueHistDAO(MySqlConnection mySqlConnection)
        {
        ...
        public int insert(int emplID, string modifiedBy, bool doCommit)
        {
            ...
            try
            {
                ...
                sbInsert.Append("INSERT INTO employee_counter_values_hist ");
                sbInsert.Append("(employee_counter_type_id, employee_id, value, measure_unit, created_by, created_time, modified_by, modified_time) ");
                sbInsert.Append("SELECT employee_counter_type_id, employee_id, value, measure_unit, created_by, created_time, '" + modifiedBy.Trim() + "', NOW()");
        ...
        public int getFirstModifiedValue(int emplID, int counterType)
        {
            ...
            try
            {
                select = "SELECT * FROM employee_counter_values_hist WHERE employee_id = '" + emplID.ToString().Trim() + "' AND employee_counter_type_id = '"
                    + counterType.ToString().Trim() + "' AND modified_by <> '" + Constants.syncUser.Trim() + "'  ORDER BY modified_time LIMIT 1 OFFSET 0";
