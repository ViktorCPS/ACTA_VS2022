...
{
	/// <summary>
	/// Summary description for MySQLVisitDAO.
	/// </summary>
	public class MySQLVisitDAO : VisitDAO
	{
		MySqlConnection conn = null;
		MySqlTransaction _sqlTrans = null;
		protected string dateTimeformat = "";

		public MySQLVisitDAO()
		{
			conn = MySQLDAOFactory.getConnection();
			DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
			dateTimeformat = dateTimeFormat.SortableDateTimePattern;
		}
        public MySQLVisitDAO(MySqlConnection mySqlConnection)
        {
          ...
          string visitAsco4, Dictionary<int, List<VisitAsco4TO>> ascoTO)
        {
            ...
            try
            {
                ...
                sb.Append(" SELECT DISTINCT visits.first_name,visits.first_name,visits.visitor_id,visits.visitor_jmbg,visits.company,asco4.integer_value_1 AS ban ");
               ...
               // select = sb.ToString() + " ORDER BY date_start";
                ...
                if (table.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow row in table.Rows)
                    {
                        ...
                        {
                            visit.VisitID = int.Parse(row["ban"].ToString().Trim());
                        }
        ...
        public DataSet getVisitsCompletedDS()
        {
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.Append("SELECT v.first_name , v.last_name , v.employee_id , e.first_name visit_1, e.last_name visit_2, ");
                sb.Append("a.n_varchar_value_2 document_name, v.company , v.visit_descr description, a.datetime_value1 privacy_statement, v.date_start ,v.date_end ");
                sb.Append(" FROM visits v, visit_acso4 a, employees e WHERE date_end IS NOT NULL ");
                select = sb.ToString();
            ...
            string visitAsco4, Dictionary<int, List<VisitAsco4TO>> ascoTO)
        {
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.Append(" SELECT visits.*, e1.first_name AS EmplFirstName, e1.last_name AS EmplLastName, wu.name AS WUName, e2.firest_name AS visited_first_name, e2.last_name AS visited_last_name ");
                sb.Append("asco4.nvarchar_value_2 as document_name, asco4.datetime_value_1 AS privacy_statement, asco4.nvarchar_value_8 AS local ");
                sb.Append(" FROM visits, employees AS e1,employees AS e2, working_units AS wu, visits_asco4 AS asco4");
                sb.Append(" WHERE visits.employee_id = e1.employee_id");
                sb.Append(" WHERE visits.visited_person = e2.employee_id");
                sb.Append(" AND visits.visited_working_unit = wu.working_unit_id");
                sb.Append(" AND visits.visit_id = asco4.visit_id");
                    ...
                    (!privacy.Equals("")) || (!visitAsco4.Equals("")))
                {
                    ...
                    if (!visitAsco4.Trim().Equals(""))
                    {
                        sb.Append(" AND UPPER(asco4.nvarchar_value_1) = '" + visitAsco4.Trim().ToUpper() + "'");
                    }
                    if (!visitedPerson.Equals(""))
                    {
                        sb.Append(" AND visits.visited_person = " + visitedPerson);
                    ...
                    if (!company.Trim().Equals(""))
                    {
                        sb.Append(" AND company = '" + company.Trim() + "'");
                    }
                    if (!state.Trim().Equals(""))
                    {
                        sb.Append(" AND asco4.nvarchar_value_4 = '" + state.Trim() + "'");
                    }
                    if (!visitor.Trim().Equals(""))
                    {
                        sb.Append(" AND asco4.nvarchar_value_1 = '" + visitor.Trim() + "'");
                    }
                    ...
                    if (!privacy.Equals(""))
                    {
                        if (privacy.Equals("YES"))
                        {
                            sb.Append(" AND asco4.datetime_value_1 <> NULL ");
                        }
                        if (privacy.Equals("NO"))
                        {
                            sb.Append(" AND asco4.datetime_value_1 = NULL ");
                ...
                if (table.Rows.Count > 0)
                {
                    foreach (DataRow row in table.Rows)
                    {
                        ...
                        if (row["visited_firs_name"] != DBNull.Value)
                        {
                            visit.VisitedFirstName = row["visited_firs_name"].ToString().Trim();
                        }
                        if (row["visited_last_name"] != DBNull.Value)
                        {
                            visit.VisitedLastName = row["visited_last_name"].ToString().Trim();
                        }
		...
		public int insert(VisitTO visitTO)
		{
			...
			try
			{
                ...
                sbInsert.Append("SELECT LAST_INSERT_ID() AS visit_id ");
		...
		public VisitTO find(string employeeID)
		{
			...
			try
			{
				...
				if (table.Rows.Count == 1)
				{
					...
					{
						visit.DateStart = DateTime.Parse( table.Rows[0]["date_start"].ToString());
					}
					if (table.Rows[0]["date_end"] != DBNull.Value)
					{
						visit.DateEnd = DateTime.Parse( table.Rows[0]["date_end"].ToString());
					}
            ...
            int locationID, string remarks)
        {
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.Append("SELECT v.*, e.last_name as last,e.first_name as first FROM visits v, employees e ");
                ...
                if (table.Rows.Count > 0)
                {
                    foreach (DataRow row in table.Rows)
                    {
                        ...
                        if (row["date_start"] != DBNull.Value)
                        {
                            visit.DateStart = DateTime.Parse(row["date_start"].ToString());
                        }
                        if (row["date_end"] != DBNull.Value)
                        {
                            visit.DateEnd = DateTime.Parse(row["date_end"].ToString());
                        }
                        if (row["visited_person"] != DBNull.Value)
                        {
                            visit.VisitedPerson = Int32.Parse(row["visited_person"].ToString().Trim());
            ...
            try
            {
                    ...
                    (!visitDescr.Trim().Equals("")) || (!wUnits.Trim().Equals("")))
                {
                    ...
                    if ((!dateFrom.Equals(new DateTime())) && (!dateTo.Equals(new DateTime())))
                    {
                        ...
                        sb.Append(" (");
                        sb.Append(" convert(date_format(date_start, '%Y-%m-%d'), datetime) < convert('" + dateFrom.ToString("yyyy-MM-dd") + "', datetime)");
                        sb.Append(" AND (convert(date_format(date_end, '%Y-%m-%d'), datetime) >= convert('" + dateFrom.ToString("yyyy-MM-dd") + "', datetime)");
                        sb.Append(" OR date_end IS NULL)");
                        sb.Append(" )");

                        sb.Append(" OR (");
                        sb.Append(" convert(date_format(date_start, '%Y-%m-%d'), datetime) >= convert('" + dateFrom.ToString("yyyy-MM-dd") + "', datetime)");
                        sb.Append(" AND convert(date_format(date_start, '%Y-%m-%d'), datetime) <= convert('" + dateTo.ToString("yyyy-MM-dd") + "', datetime)");
                        sb.Append(" )");
        ...
        public List<string> getDistinctVisitType()
        {
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.Append("SELECT DISTINCT visit_descr from visits");
        ...
        public List<string> getDistinctName()
        {
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.Append("SELECT DISTINCT first_name,last_name from visits");
                select = sb.ToString().Trim();
                MySqlCommand cmd = new MySqlCommand(select, conn);
                MySqlDataAdapter sqlDataAdapter = new MySqlDataAdapter(cmd);
        ...
        public List<string> getDistinctCompany()
        {
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.Append("SELECT DISTINCT company from visits");
                select = sb.ToString().Trim();
                MySqlCommand cmd = new MySqlCommand(select, conn);
                MySqlDataAdapter sqlDataAdapter = new MySqlDataAdapter(cmd);
		...
		public bool serialize(System.Collections.ArrayList visitTOList)
		{
			bool isSerialized = false;
