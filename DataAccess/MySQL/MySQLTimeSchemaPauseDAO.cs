...
{
	/// <summary>
	/// Summary description for MySQLTimeSchemaPauseDAO.
	/// </summary>
	public class MySQLTimeSchemaPauseDAO : TimeSchemaPauseDAO
	{
		MySqlConnection conn = null;

		public MySQLTimeSchemaPauseDAO()
		{
			conn = MySQLDAOFactory.getConnection();
		}
        public MySQLTimeSchemaPauseDAO(MySqlConnection mySqlConnection)
        {
		...
		public TimeSchemaPauseTO find(int pauseID)
		{
			...
			try
			{
				MySqlCommand cmd = new MySqlCommand("SELECT pause_id, description, pause_duration, earliest_use_time, latest_use_time, pause_offset, short_break_duration FROM time_schema_pauses WHERE pause_id = " + pauseID, conn );
		...
		public int findMAXPauseID()
		{
			...
			try
			{
				MySqlCommand cmd = new MySqlCommand( "SELECT MAX(pause_id) AS pause_id FROM time_schema_pauses", conn );
				MySqlDataAdapter sqlDataAdapter = new MySqlDataAdapter(cmd);
