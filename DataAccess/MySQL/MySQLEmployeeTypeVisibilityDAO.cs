...
{
    public class MySQLEmployeeTypeVisibilityDAO : EmployeeTypeVisibilityDAO
    {
        ...
        public MySQLEmployeeTypeVisibilityDAO()
        {
        ...
        public MySQLEmployeeTypeVisibilityDAO(MySqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
