...
{
    public class MySQLMedicalCheckPointDAO : MedicalCheckPointDAO
    {
        ...
        public MySQLMedicalCheckPointDAO()
        {
        ...
        public MySQLMedicalCheckPointDAO(MySqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
