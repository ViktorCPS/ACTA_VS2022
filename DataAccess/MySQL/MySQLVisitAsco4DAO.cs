...
{
    public class MySQLVisitAsco4DAO:VisitAsco4DAO
    {
        ...
        public MySQLVisitAsco4DAO()
		{
			conn = MySQLDAOFactory.getConnection();
			DAOController.GetInstance();
		}
        public MySQLVisitAsco4DAO(MySqlConnection mySqlConnection)
        {
            ...
            string string6, string string7, string string8, string string9, string string10)
        {
            ...
            try
            {
                     ...
                     || (!string6.Equals("")) || (!string7.Equals("")) || (!string8.Equals("")) || (!string9.Equals("")) || (!string10.Equals("")))
                {
                    ...
                    {
                        sb.Append(" datetime_value_1 = CONVERT('" + dateTime1.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!dateTime2.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_2 = CONVERT('" + dateTime2.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!dateTime3.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_3 = CONVERT('" + dateTime3.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!dateTime4.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_4 = CONVERT('" + dateTime4.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!dateTime5.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_5 = CONVERT('" + dateTime5.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!dateTime6.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_6 = CONVERT('" + dateTime6.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!dateTime7.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_7 = CONVERT('" + dateTime7.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!dateTime8.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_8 = CONVERT('" + dateTime8.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!dateTime9.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_9 = CONVERT('" + dateTime9.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!dateTime10.Equals(new DateTime()))
                    {
                        sb.Append(" datetime_value_10 = CONVERT('" + dateTime10.ToString("yyyy-MM-dd") + "', datetime) AND ");
                    }
                    if (!string1.Equals(""))
                    {
        ...
        public List<string> getDistinct(string column)
        {
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.Append("SELECT DISTINCT "+column+" from visits_asco4");
                ...
                if (table.Rows.Count > 0)
                {
                    foreach (DataRow row in table.Rows)
                    {
                        ...
                        if (row["nvarchar_value_4"] != DBNull.Value)
                        {
                            visitors.Add(row["nvarchar_value_4"].ToString().Trim());
                        }
                    }
                }
            }
        ...
        public List<string> getDistinctVisitors()
        {
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.Append("SELECT DISTINCT nvarchar_value_1 from visits_asco4");
                select = sb.ToString().Trim();
                MySqlCommand cmd = new MySqlCommand(select, conn);
                MySqlDataAdapter sqlDataAdapter = new MySqlDataAdapter(cmd);
        ...
        public List<string> getDistinctDocumentNames()
        {
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.Append("SELECT DISTINCT nvarchar_value_2 from visits_asco4");
                select = sb.ToString().Trim();
                MySqlCommand cmd = new MySqlCommand(select, conn);
                MySqlDataAdapter sqlDataAdapter = new MySqlDataAdapter(cmd);
