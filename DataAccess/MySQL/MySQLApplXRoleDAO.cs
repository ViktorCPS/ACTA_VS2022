...
{
	/// <summary>
	/// Summary description for MySQLApplXRoleDAO.
	/// </summary>
	public class MySQLApplXRoleDAO : ApplUsersXRoleDAO
	{
		...
		public MySQLApplXRoleDAO()
		{
			conn = MySQLDAOFactory.getConnection();
		}
        public MySQLApplXRoleDAO(MySqlConnection mySqlConnection)
        {
		...
		public ApplUsersXRoleTO find(string userID, int roleID)
		{
			...
			try
			{
				...
				sbFind.Append("SELECT * FROM appl_users_x_appl_roles WHERE");
		...
		{
			MySQLApplRoleDAO roleDAO = (MySQLApplRoleDAO) factory.getApplRoleDAO(null);
