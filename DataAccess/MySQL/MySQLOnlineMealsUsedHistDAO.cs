...
{
    public class MySQLOnlineMealsUsedHistDAO : OnlineMealsUsedHistDAO
    {
        ...
        public MySQLOnlineMealsUsedHistDAO()
        {
        ...
        public MySQLOnlineMealsUsedHistDAO(MySqlConnection mySqlConnection)
        {
        ...
        public int insert(OnlineMealsUsedHistTO onlineMealUsedTO, bool doCommit)
        {
            ...
            try
            {
                ...
                sbInsert.Append("modified_by = N'" + DAOController.GetLogInUser().ToString().Trim() + "', modified_time = " + " NOW() ");
        ...
        public List<OnlineMealsUsedHistTO> getMealsUsed(string transactionID)
        {
            ...
            try
            {
                ...
                if (!transactionID.Equals("transaction_id = '" + transactionID + "' AND "))
                {
