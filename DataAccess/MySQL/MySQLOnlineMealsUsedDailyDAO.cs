...
{
    public class MySQLOnlineMealsUsedDailyDAO:OnlineMealsUsedDailyDAO
    {
        ...
        public MySQLOnlineMealsUsedDailyDAO()
        {
        ...
        public MySQLOnlineMealsUsedDailyDAO(MySqlConnection mySqlConnection)
        {
        ...
        public bool updateToTransfered(string transIDs, bool doCommit)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand(updateString.Trim(), conn, SqlTrans);
        ...
        public bool deletePreviousDay(bool doCommit)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand(select.Trim(), conn, SqlTrans);
