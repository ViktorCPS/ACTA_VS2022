...
{
    public class MySQLSecurityRouteDAO : SecurityRouteDAO
    {
        MySqlConnection conn = null;
		protected string dateTimeformat = "";

        public MySQLSecurityRouteDAO()
		{
			conn = MySQLDAOFactory.getConnection();	
			DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
			dateTimeformat = dateTimeFormat.SortableDateTimePattern;
		}
        public MySQLSecurityRouteDAO(MySqlConnection mySqlConnection)
        {
        ...
        public int insert(SecurityRouteHdrTO secRouteTO)
        {
            ...
            try
            {
                ...
                sbInsert.Append("VALUES (N'" + secRouteTO.Name.Trim() + "', N'" + secRouteTO.Description.Trim() +
                    "', N'" + secRouteTO.RouteType.Trim() + "', N'" + DAOController.GetLogInUser().Trim() + "', NOW()); ");
                sbInsert.Append("SELECT LAST_INSERT_ID() AS security_route_id ");
        ...
        public bool delete(int securityRouteID)
        {
            ...
            try
            {
                ...
                select = "DELETE FROM security_routes_dtl WHERE security_route_id = '" + securityRouteID.ToString().Trim() + "' ";
                MySqlCommand cmd = new MySqlCommand(select, conn, trans);
                int affectedRows = cmd.ExecuteNonQuery();

                //Delete from security_routes_hdr
                select = "DELETE FROM security_routes_hdr WHERE security_route_id = '" + securityRouteID.ToString().Trim() + "' ";
