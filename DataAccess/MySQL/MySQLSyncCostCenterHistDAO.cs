...
{
    public class MySQLSyncCostCenterHistDAO : SyncCostCenterHistDAO
    {
		...
		public MySQLSyncCostCenterHistDAO()
		{
        ...
        public MySQLSyncCostCenterHistDAO(MySqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
        ...
        public bool insert(SyncCostCenterTO syncCC, bool doCommit)
        {
            ...
            try
            {
                ...
                sbInsert.Append("(rec_id, cost_center_code, cost_center_company_code, cost_center_description, valid_from, created_by, created_time, created_time_hist, result, remark) ");
