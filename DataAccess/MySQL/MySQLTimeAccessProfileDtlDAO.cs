...
{
	/// <summary>
	/// Summary description for MySQLTimeAccessProfileDtlDAO.
	/// </summary>
	public class MySQLTimeAccessProfileDtlDAO : TimeAccessProfileDtlDAO
	{
		...
		public MySQLTimeAccessProfileDtlDAO()
		{
			conn = MySQLDAOFactory.getConnection();
		}
        public MySQLTimeAccessProfileDtlDAO(MySqlConnection mySqlConnection)
        {
		...
		public TimeAccessProfileDtlTO find(string timeAccessProfileId, string dayOfWeek, string direction)
		{
			...
			try
			{
				MySqlCommand cmd = new MySqlCommand("SELECT * FROM timeaccess_profiles_dtl WHERE timeaccess_profile_id = " + Int32.Parse(timeAccessProfileId.Trim())
