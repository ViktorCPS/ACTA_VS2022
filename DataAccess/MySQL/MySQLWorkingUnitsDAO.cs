...
{
    /// <summary>
    /// MySQLWorkingUnitsDAO implements MSSQL WorkingUnits Data Access Object
    /// </summary>
    public class MySQLWorkingUnitsDAO : WorkingUnitsDAO
    {
        ...
        /// </summary>
        public MySQLWorkingUnitsDAO()
        {
            conn = MySQLDAOFactory.getConnection();
        }

        public MySQLWorkingUnitsDAO(MySqlConnection mySqlConnection)
        {
        ...
        /// <summary>
        /// Insert WorkingUnit to working_units table
        /// </summary>
        ...
        public int insert(WorkingUnitTO wuTO)
        {
            ...
            try
            {
                ...
                sbInsert.Append("VALUES ('" + wuTO.WorkingUnitID + "', ");
            ...
            catch (MySqlException ex)
            {
                ...
                {
                    throw new Exception("Working Unit with the same Working Unit ID already exist.");
                }
                else
                    throw ex;
            }
        ...
        public bool delete(int workingUnitsID)
        {
            ...
            try
            {
                ...
                sbDelete.Append("DELETE FROM working_units WHERE working_unit_id = " + workingUnitsID.ToString().Trim());
        ...
        public bool update(WorkingUnitTO wuTO)
        {
            ...
            try
            {
                ...
                sbUpdate.Append("WHERE working_unit_id = '" + wuTO.WorkingUnitID.ToString().Trim() + "'");
        ...
        /// </summary>
        /// <param name="workingUnitID">primary key</param>
        /// <returns>WorkingUnit object if succedeed</returns>
        public WorkingUnitTO find(int workingUnitID)
        {
            ...
            try
            {
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM working_units WHERE working_unit_id = " + workingUnitID + " ", conn);
        ...
        private int getNumberOfEmployees(int workingUnitID)
        {
            ...
            try
            {
                MySqlCommand cmd = new MySqlCommand("SELECT COUNT(*)employees_number FROM employees WHERE working_unit_id = " + workingUnitID + " ", conn);
                MySqlDataAdapter sqlDataAdapter = new MySqlDataAdapter(cmd);
        ...
        private int getNumberOfChild(int workingUnitID)
        {
            ...
            try
            {
                MySqlCommand cmd = new MySqlCommand("SELECT COUNT(*)child_number FROM working_units WHERE parent_working_unit_id = " + workingUnitID + " ", conn);
                MySqlDataAdapter sqlDataAdapter = new MySqlDataAdapter(cmd);
        ...
        public WorkingUnitTO find(int workingUnitID, bool useTrans)
        {
            ...
            try
            {
                ...
                if (useTrans)
                    cmd = new MySqlCommand("SELECT * FROM working_units WHERE working_unit_id = " + workingUnitID + " ", conn, SqlTrans);
                else
                    cmd = new MySqlCommand("SELECT * FROM working_units WHERE working_unit_id = " + workingUnitID + " ", conn);
        ...
        public int findMAXWUID()
        {
            ...
            try
            {
                MySqlCommand cmd = new MySqlCommand("SELECT MAX(working_unit_id) AS wu_id FROM working_units", conn);
                MySqlDataAdapter sqlDataAdapter = new MySqlDataAdapter(cmd);
        ...
        public int findMINWUID()
        {
            ...
            try
            {
                MySqlCommand cmd = new MySqlCommand("SELECT MIN(working_unit_id) AS wu_id FROM working_units", conn);
                MySqlDataAdapter sqlDataAdapter = new MySqlDataAdapter(cmd);
