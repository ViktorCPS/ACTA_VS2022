...
{
   public class MySQLSyncEmployeesHistDAO:SyncEmployeesHistDAO
    {
		...
		public MySQLSyncEmployeesHistDAO()
		{
        ...
        public MySQLSyncEmployeesHistDAO(MySqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
       ...
       public bool insert(SyncEmployeeTO syncEmpl, bool doCommit)
        {
            ...
            try
            {
                ...
                if (syncEmpl.Picture != null)
                    cmd.Parameters.Add("@Content", MySqlDbType.MediumBlob, syncEmpl.Picture.Length).Value = syncEmpl.Picture;
       ...
       public int getLastOU(int employeeID)
       {
           ...
           try
           {
               ...
               select = "SELECT organizational_unit_id FROM sync_employees_hist WHERE employee_id = '" + employeeID.ToString().Trim() + "' AND organizational_unit_id IS NOT NULL ORDER BY created_time_hist DESC LIMIT 1";
       ...
       public int getLastWU(int employeeID)
       {
           ...
           try
           {
               ...
               select = "SELECT fs_unit_id FROM sync_employees_hist WHERE employee_id = '" + employeeID.ToString().Trim() + "' AND fs_unit_id IS NOT NULL ORDER BY created_time_hist DESC LIMIT 1";
