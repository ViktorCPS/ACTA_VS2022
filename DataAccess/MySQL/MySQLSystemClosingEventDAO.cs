...
{
    public class MySQLSystemClosingEventDAO : SystemClosingEventDAO
    {
        ...
        public MySQLSystemClosingEventDAO()
		{
        ...
        public MySQLSystemClosingEventDAO(MySqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
