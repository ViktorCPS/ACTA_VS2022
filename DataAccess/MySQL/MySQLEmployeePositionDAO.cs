...
{
    public class MySQLEmployeePositionDAO : EmployeePositionDAO
    {
        ...
        public MySQLEmployeePositionDAO()
        {
        ...
        public MySQLEmployeePositionDAO(MySqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
        ...
        public List<EmployeePositionTO> getEmployeePositions(EmployeePositionTO posTO)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand(select + " ORDER BY position_code", conn);
