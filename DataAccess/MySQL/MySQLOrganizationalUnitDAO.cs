...
{
    public class MySQLOrganizationalUnitDAO : OrganizationalUnitDAO
    {
        ...
        public MySQLOrganizationalUnitDAO()
        {
        ...
        public MySQLOrganizationalUnitDAO(MySqlConnection mySqlConnection)
        {
        ...
        public OrganizationalUnitTO find(int ouID)
        {
            ...
            try
            {
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM organizational_units WHERE organizational_unit_id = '" + ouID.ToString().Trim() + "'", conn);
        ...
        public int findMAXOUID()
        {
            ...
            try
            {
                MySqlCommand cmd = new MySqlCommand("SELECT MAX(organizational_unit_id) AS ou_id FROM organizational_units", conn);
                MySqlDataAdapter sqlDataAdapter = new MySqlDataAdapter(cmd);
                ...
                {
                    wuID = Int32.Parse(table.Rows[0]["ou_id"].ToString().Trim());
                }
            }
            catch (Exception ex)
            {
