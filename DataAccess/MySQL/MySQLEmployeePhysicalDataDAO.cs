...
{
    public class MySQLEmployeePhysicalDataDAO : EmployeePhysicalDataDAO
    {
        ...
        public MySQLEmployeePhysicalDataDAO()
        {
        ...
        public MySQLEmployeePhysicalDataDAO(MySqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
        ...
        public List<EmployeePhysicalDataTO> getEmployeePhysicalData(EmployeePhysicalDataTO dataTO)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand(select + " ORDER BY employee_id, date_performed", conn);
