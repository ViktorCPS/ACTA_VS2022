...
{
	/// <summary>
	/// Summary description for MySQLApplRoleDAO.
	/// </summary>
	public class MySQLApplRoleDAO : ApplRoleDAO
	{
		...
		public MySQLApplRoleDAO()
		{
			conn = MySQLDAOFactory.getConnection();
		}
        public MySQLApplRoleDAO(MySqlConnection mySqlConnection)
        {
		...
		public ApplRoleTO find(int applRoleID)
		{
			...
			try
			{
				MySqlCommand cmd = new MySqlCommand( "SELECT * FROM appl_roles WHERE appl_role_id = '" + applRoleID.ToString().Trim() + "'", conn );
		...
		public int findEmptyRole()
		{
			...
			try
			{
				MySqlCommand cmd = new MySqlCommand( "SELECT MIN(appl_role_id) AS appl_role_id FROM appl_roles WHERE name LIKE 'EMPTY ROLE%'", conn );
				MySqlDataAdapter sqlDataAdapter = new MySqlDataAdapter(cmd);
		...
		{
			MySQLApplMenuItemDAO menuItemDAO = (MySQLApplMenuItemDAO) factory.getApplMenuItemDAO(null);
