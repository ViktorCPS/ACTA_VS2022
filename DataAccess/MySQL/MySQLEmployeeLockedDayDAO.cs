...
{
    public class MySQLEmployeeLockedDayDAO : EmployeeLockedDayDAO
    {
        ...
        public MySQLEmployeeLockedDayDAO()
		{
			conn = MySQLDAOFactory.getConnection();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
		}
        public MySQLEmployeeLockedDayDAO(MySqlConnection mySqlConnection)
        {
        ...
        public Dictionary<int, List<DateTime>> getLockedDays(string emplIDs, string type, DateTime fromDate, DateTime toDate)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand(select + " ORDER BY employee_id, type, date", conn);
