...
{
    public class MySQLApplUserCategoryDAO : ApplUserCategoryDAO
    {
        ...
        public MySQLApplUserCategoryDAO()
		{
        ...
        public MySQLApplUserCategoryDAO(MySqlConnection mySqlConnection)
        {
        ...
        public ApplUserCategoryTO find(int categoryID)
        {
            ...
            try
            {
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM appl_users_categories WHERE appl_users_category_id = '" + categoryID.ToString().Trim() + "'", conn);
