...
{
    public class MySQLMedicalCheckVisitDtlHistDAO : MedicalCheckVisitDtlHistDAO
    {
        ...
        public MySQLMedicalCheckVisitDtlHistDAO()
        {
        ...
        public MySQLMedicalCheckVisitDtlHistDAO(MySqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
