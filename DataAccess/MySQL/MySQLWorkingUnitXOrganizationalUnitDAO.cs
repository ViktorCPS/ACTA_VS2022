...
{
    public class MySQLWorkingUnitXOrganizationalUnitDAO : WorkingUnitXOrganizationalUnitDAO
    {
        ...
        public MySQLWorkingUnitXOrganizationalUnitDAO()
        {
            conn = MySQLDAOFactory.getConnection();
        }

        public MySQLWorkingUnitXOrganizationalUnitDAO(MySqlConnection sqlConnection)
        {
            conn = sqlConnection;
