...
{
    public class MSSQLEmployeeCounterValueDAO : EmployeeCounterValueDAO
    {
        ...
        public MSSQLEmployeeCounterValueDAO()
		{
			conn = MSSQLDAOFactory.getConnection();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
		}
        public MSSQLEmployeeCounterValueDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
             DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
        ...
        public EmployeeCounterValueTO find(int typeID, int emplID)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("SELECT * FROM employee_counter_values WHERE employee_counter_type_id = '" + typeID.ToString().Trim() + "' AND employee_id = '" + emplID.ToString().Trim() + "'", conn);
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(cmd);
