...
{
    public class MSSQLEmployeePYDataAnaliticalDAO : EmployeePYDataAnaliticalDAO
    {
        ...
        public MSSQLEmployeePYDataAnaliticalDAO()
        {
        ...
        public MSSQLEmployeePYDataAnaliticalDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
        ...
        public int insert(EmployeePYDataAnaliticalTO emplPYDataAnalitical, bool doCommit)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception(emplPYDataAnalitical.EmployeeID.ToString() + " " + ex.Message);
            }
