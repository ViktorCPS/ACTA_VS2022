...
{
    public class MSSQLEmployeePYTransportTypeDAO : EmployeePYTransportTypeDAO
    {
        ...
        public MSSQLEmployeePYTransportTypeDAO()
        {
        ...
        public MSSQLEmployeePYTransportTypeDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
