...
{
    public class MSSQLEmployeeXMedicalCheckDisabilityDAO : EmployeesXMedicalCheckDisabilityDAO
    {
        ...
        public MSSQLEmployeeXMedicalCheckDisabilityDAO()
        {
        ...
        public MSSQLEmployeeXMedicalCheckDisabilityDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
        ...
        public List<EmployeeXMedicalCheckDisabilityTO> getEmployeeXMedicalCheckDisabilities(EmployeeXMedicalCheckDisabilityTO disTO)
        {
            ...
            try
            {
                ...
                if ((disTO.RecID != 0) || (disTO.EmployeeID != -1) || (disTO.DisabilityID != -1) || (!disTO.Type.Trim().Equals("")) || (!disTO.Note.Trim().Equals(""))
                    || (!disTO.DateStart.Equals(new DateTime())) || (!disTO.DateEnd.Equals(new DateTime()))
                ...
                SqlCommand cmd = new SqlCommand(select + " ORDER BY employee_id, date_start", conn);
...
{
    class MSSQLEmployeeXMedicalCheckDisabilityDAO
    {
    }
}
