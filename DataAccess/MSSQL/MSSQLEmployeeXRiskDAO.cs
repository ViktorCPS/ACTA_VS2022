...
{
    public class MSSQLEmployeeXRiskDAO : EmployeeXRiskDAO
    {
        ...
        public MSSQLEmployeeXRiskDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
        ...
        public bool delete(string recID, bool doCommit)
        {
            ...
            try
            {
                ...
                sbDelete.Append("DELETE FROM employees_x_risks WHERE rec_id IN (" + recID.Trim() + ")");
