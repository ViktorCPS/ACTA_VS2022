...
{
    public class MSSQLMedicalCheckVisitDtlDAO : MedicalCheckVisitDtlDAO
    {
        ...
        public MSSQLMedicalCheckVisitDtlDAO()
        {
        ...
        public MSSQLMedicalCheckVisitDtlDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
