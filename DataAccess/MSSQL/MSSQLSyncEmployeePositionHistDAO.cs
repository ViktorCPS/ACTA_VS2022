...
{
    public class MSSQLSyncEmployeePositionHistDAO : SyncEmployeePositionHistDAO
    {
        ...
        public MSSQLSyncEmployeePositionHistDAO()
        {
        ...
        public MSSQLSyncEmployeePositionHistDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
