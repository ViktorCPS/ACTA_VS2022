...
{
    public class MSSQLEmployeePYDataSumDAO: EmployeePYDataSumDAO
    {
		...
		public MSSQLEmployeePYDataSumDAO()
		{
        ...
        public MSSQLEmployeePYDataSumDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
        ...
        public uint getMaxCalcID()
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("SELECT MAX(py_calc_id) AS calc_id FROM employee_py_data_sum", conn);
        ...
        public DateTime getSumMonth(uint calcID)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT MAX(date_start) AS month FROM employee_py_data_sum WHERE py_calc_id = '" + calcID.ToString().Trim() + "'", conn);
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(cmd);
        ...
        public List<int> getEmployees(uint calcID)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT DISTINCT employee_id FROM employee_py_data_sum WHERE py_calc_id = '" + calcID.ToString().Trim() + "'", conn);
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(cmd);
        ...
        public List<EmployeePYDataSumTO> getEmployeesSum(EmployeePYDataSumTO emplTO)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(select + " ORDER BY rec_id", conn);
        ...
        public int insert(EmployeePYDataSumTO emplPYDataSum, bool doCommit)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception(emplPYDataSum.EmployeeID.ToString() + " " + ex.Message);
            }
