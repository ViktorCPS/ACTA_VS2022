...
{
    public class MSSQLEmployeeHistDAO:EmployeeHistDAO
    {
        ...
        public MSSQLEmployeeHistDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
        ...
        public EmployeeHistTO getDateEmployee(DateTime date, EmployeeTO emplTO)
        {
            ...
            try
            {
                ...
                string select = "SELECT TOP 1 * FROM employees_hist WHERE employee_id = '" + emplTO.EmployeeID.ToString().Trim()
        ...
        public DateTime getRetiredDate(int emplID)
        {
            ...
            try
            {
                ...
                string select = "SELECT TOP 1 valid_to FROM employees_hist WHERE employee_id = '" + emplID.ToString().Trim() + "' AND UPPER(status) = '"
                    + Constants.statusActive.Trim().ToUpper() + "' ORDER BY modified_time DESC";
