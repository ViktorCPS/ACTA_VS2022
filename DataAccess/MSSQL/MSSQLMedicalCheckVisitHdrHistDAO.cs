...
{
    public class MSSQLMedicalCheckVisitHdrHistDAO : MedicalCheckVisitHdrHistDAO
    {
        ...
        public MSSQLMedicalCheckVisitHdrHistDAO()
        {
        ...
        public MSSQLMedicalCheckVisitHdrHistDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DAOController.GetInstance();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
        ...
        public List<MedicalCheckVisitHdrHistTO> getMedicalCheckVisitHeadersHistory(MedicalCheckVisitHdrHistTO hdrTO)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(select + " ORDER BY visit_id, modified_time", conn);
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(cmd);
