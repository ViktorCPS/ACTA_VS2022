...
{
    public class MSSQLEmployeeCounterMonthlyBalanceDAO : EmployeeCounterMonthlyBalanceDAO
    {
        ...
        public MSSQLEmployeeCounterMonthlyBalanceDAO()
        {
            conn = MSSQLDAOFactory.getConnection();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
        }
        public MSSQLEmployeeCounterMonthlyBalanceDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
        ...
        {
            DataSet dataSet = new DataSet();
            DateTime month = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1).Date;            
