...
{
    public class MSSQLEmployeeResponsibilityDAO:EmployeeResponsibilityDAO
    {
		...
		public MSSQLEmployeeResponsibilityDAO()
		{
        ...
        public MSSQLEmployeeResponsibilityDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
