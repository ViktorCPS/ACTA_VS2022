...
{
    public class MSSQLMealTypeAdditionalDataDAO : MealTypeAdditionalDataDAO
    {
       ...
       protected string dateTimeformat = "";
		...
		public MSSQLMealTypeAdditionalDataDAO()
		{
			conn = MSSQLDAOFactory.getConnection();
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
		}
        public MSSQLMealTypeAdditionalDataDAO(SqlConnection sqlConnection)
        {
            conn = sqlConnection;
            DateTimeFormatInfo dateTimeFormat = new CultureInfo("en-US", true).DateTimeFormat;
            dateTimeformat = dateTimeFormat.SortableDateTimePattern;
        ...
        public int tableExists()
        {
            int exists = 0;
            DataSet dataSet = new DataSet();
            SqlTransaction sqlTrans = conn.BeginTransaction(IsolationLevel.RepeatableRead, "SELECT");
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(sbSelect.ToString(), conn, sqlTrans);
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(cmd);
