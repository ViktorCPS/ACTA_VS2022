...
namespace Common
{
     public  class IOPairProcessed
    {
        ...
        public List<IOPairProcessedTO> SearchAllPairsForEmpl(string employeeIDString, List<DateTime> datesList, string ptIDs, DateTime lastDate)
        {
            try
            {
                return edao.getIOPairsAllForEmpl(employeeIDString, datesList, ptIDs, lastDate);
            }
            catch (Exception ex)
            {
                log.writeLog(DateTime.Now + " IOPairProcessed.BankHoursMonthly(): " + ex.Message + "\n");
                throw new Exception(ex.Message);
            }
        }
        ...
        public int BankHoursMonthly(int emplID, DateTime month)
        {
            try
            {
                return edao.BankHoursMonthly(emplID, month);
            }
            catch (Exception ex)
            {
                log.writeLog(DateTime.Now + " IOPairProcessed.BankHoursMonthly(): " + ex.Message + "\n");
        ...
        public int BankHoursPeriodical(int emplID, DateTime fromDate, DateTime toDate)
        {
            try
            {
                return edao.BankHoursPeriodical(emplID, fromDate, toDate);
            }
            catch (Exception ex)
            {
                log.writeLog(DateTime.Now + " IOPairProcessed.BankHoursMonthly(): " + ex.Message + "\n");
        ...
        public int BankHours6Months(int emplID,DateTime month)
        {
            try
            {
                return edao.BankHours6Months(emplID, month);
            }
            catch (Exception ex)
            {
                log.writeLog(DateTime.Now + " IOPairProcessed.BankHoursMonthly(): " + ex.Message + "\n");
        ...
        public int radneSubote(int emplID, DateTime month)
        {
            try
            {
                return edao.radneSubote(emplID, month);
            }
            catch (Exception ex)
            {
                log.writeLog(DateTime.Now + " IOPairProcessed.BankHoursMonthly(): " + ex.Message + "\n");
        ...
        public void BankHours6MonthsPay(int emplID, DateTime mesec)
        {
            try
            {
                edao.BankHours6MonthsPay(emplID, mesec);
            }
            catch (Exception ex)
            {
                log.writeLog(DateTime.Now + " IOPairProcessed.BankHoursMonthly(): " + ex.Message + "\n");
        ...
        public List<IOPairProcessedTO> pairsForPeriod(string emplIDs, DateTime from, DateTime to)
        {
            try
            {
                return edao.pairsForPeriod(emplIDs, from, to);
            }
            catch (Exception ex)
            {
                log.writeLog(DateTime.Now + " IOPairProcessed.pairsForPeriod(): " + ex.Message + "\n");
                throw new Exception(ex.Message);
            }
        }
        public List<IOPairProcessedTO> pairsForPeriod(string emplIDs, DateTime from, DateTime to, string passType)
        {
            try
            {
                return edao.pairsForPeriod(emplIDs, from, to, passType);
            }
            catch (Exception ex)
            {
                log.writeLog(DateTime.Now + " IOPairProcessed.pairsForPeriod(passType): " + ex.Message + "\n");
                throw new Exception(ex.Message);
            }
        }
        ...
        public void deleteIoPairProcForAutoTimeSchema(int emplID, DateTime date, bool doCommit)
        {
            try
            {
                edao.deleteIoPairProcForAutoTimeSchema(emplID, date, doCommit);
            }
            catch (Exception ex)
            {
                log.writeLog(DateTime.Now + " IOPairProcessed.deleteIoPairProcForAutoTimeSchema(): " + ex.Message + "\n");
                throw new Exception(ex.Message);
            }
        }
