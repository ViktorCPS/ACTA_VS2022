...
{
    public partial class TLPayedLeavesReportPage : System.Web.UI.Page
    {
        const string pageName = "TLPaidLeavesReportPage";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                try
                {
                    Response.Redirect("/ACTAWeb/CommonWeb/MessagesPages/ErrorPage.aspx?Error=Error in TLPayedLeaveReportPage.Page_Load(): " + ex.Message.Replace('\n', ' ').Trim() + "&Header=" + Constants.falseValue.Trim(), false);
                }
