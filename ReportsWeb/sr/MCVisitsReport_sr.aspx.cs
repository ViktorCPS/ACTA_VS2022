...
{
    public partial class MCVisitsReport_sr : System.Web.UI.Page
    {
        const string pageName = "MCVisitsReport_sr";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = @"ReportsWeb\sr\MCVisitsSearchReport_sr.rdlc";
