<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TLClockDataReport_sr.aspx.cs" Inherits="ReportsWeb.sr.TLClockDataReport" %>
   ...
   <div style="width: 1098px; height: 500px;">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="450px" 
            Width="812px">
            <LocalReport ReportPath="ReportsWeb\sr\TLClockDataReport_sr.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
