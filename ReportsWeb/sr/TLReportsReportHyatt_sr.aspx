<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TLReportsReportHyatt_sr.aspx.cs" Inherits="ReportsWeb.sr.TLReportsReport_sr" %>
...
<body>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="450px" Width="812px" style="margin-left: 0px" ZoomPercent="100" ZoomMode="Percent">
            <LocalReport ReportPath="ReportsWeb\sr\TLReportsReport_sr.rdlc">
            </LocalReport>
    </rsweb:ReportViewer>
    </div>
    </form>
