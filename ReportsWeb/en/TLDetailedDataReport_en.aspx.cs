...
{
    public partial class TLDetailedDataReport_en : System.Web.UI.Page
    {
        ...
        const string pageName = "TLDetailedDataReport_en";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                try
                {
                    Response.Redirect("/ACTAWeb/CommonWeb/MessagesPages/ErrorPage.aspx?Error=Error in TLDetailedDataReport_en.subreportProcessingEvent(): " + ex.Message.Replace('\n', ' ').Trim() + "&Header=" + Constants.falseValue.Trim(), false);
                }
