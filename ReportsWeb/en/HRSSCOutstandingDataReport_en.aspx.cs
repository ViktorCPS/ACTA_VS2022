...
{
    public partial class HRSSCOutstandingDataReport_en : System.Web.UI.Page
    {
        const string pageName = "HRSSCOutstandingDataReport_en";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                try
                {
                    Response.Redirect("/ACTAWeb/CommonWeb/MessagesPages/ErrorPage.aspx?Error=Error in HRSSCOutstandingDataReport_en.Page_Load(): " + ex.Message.Replace('\n', ' ').Trim() + "&Header=" + Constants.falseValue.Trim(), false);
                }
