...
namespace UI
{
    public partial class EmployeeDocMaintenance : Form
    {
        ...
        private void populateEmployeeCombo(WorkingUnitTO wu)
        {
            ...
            {
                log.writeLog(DateTime.Now + " EmployeeDocMaintenance.populateEmployeeCombo(): " + ex.Message + "\n");
        ...
        private void populateWorkingUnitCombo()
        {
            ...
            {
                log.writeLog(DateTime.Now + " EmployeeDocMaintenance.populateWorkingUnitCombo(): " + ex.Message + "\n");
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            {
                log.writeLog(DateTime.Now + " EmployeeDocMaintenance.btnClose_Click(): " + ex.Message + "\n");
                MessageBox.Show(ex.Message);
            }
            finally
            {
        ...
        private void setLanguage()
        {
            ...
            {
                log.writeLog(DateTime.Now + " EmployeeDocMaintenance.setLanguage(): " + ex.Message + "\n");
                MessageBox.Show(ex.Message);
            }
        }
        ...
        private void btnBrowseLoad_Click(object sender, EventArgs e)
        {
            ...
            {
                log.writeLog(DateTime.Now + " EmployeeDocMaintenance.btnBrowseLoad_Click(): " + ex.Message + "\n");
                MessageBox.Show(ex.Message);
            }
            finally
            {
        ...
        private void btnStartLoad_Click(object sender, EventArgs e)
        {
            ...
            {
                log.writeLog(DateTime.Now + " EmployeeDocMaintenance.btnStartLoad_Click(): " + ex.Message + "\n");
                MessageBox.Show(ex.Message);
            }
            finally
            {
        ...
        private void clearProgressBar(ProgressBar pb, Label lbl)
        {
            ...
            {
                log.writeLog(DateTime.Now + " EmployeeDocMaintenance.clearProgressBar(): " + ex.Message + "\n");
                MessageBox.Show(ex.Message);
            }
        }

        private void EmployeeDocMaintenance_KeyUp(object sender, KeyEventArgs e)
        {
            this.Cursor = Cursors.WaitCursor;
            try
            {
            ...
            {
                log.writeLog(DateTime.Now + " EmployeeDocMaintenance.EmployeeDocMaintenance_KeyUp(): " + ex.Message + "\n");
                MessageBox.Show(ex.Message);
            }
            finally
            {
        ...
        private void btnWUTree_Click(object sender, EventArgs e)
        {
            ...
            {
                log.writeLog(DateTime.Now + " EmployeeDocMaintenance.btnWUTreeView_Click(): " + ex.Message + "\n");
                MessageBox.Show(ex.Message);
            }
            finally
            {
        ...
        private void gbProgress_Enter(object sender, EventArgs e)
        {

        }

        private void gbDestination_Enter(object sender, EventArgs e)
        {
        ...
        private void lblWU_Click(object sender, EventArgs e)
        {
