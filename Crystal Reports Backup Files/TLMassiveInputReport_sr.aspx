<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TLMassiveInputReport_sr.aspx.cs" Inherits="ReportsWeb.sr.TLMassiveInputReport_sr" %>
...
<body>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <LocalReport ReportPath="ReportsWeb\sr\TLMassiveInputReport_sr.rdlc"></LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
