<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRSSCOutstandingDataPage.aspx.cs" Inherits="ACTAWebUI.HRSSCOutstandingDataPage" %>
                                ...
                                <asp:Table ID="Table7" runat="server" Width="150px" CssClass="tabTable">
                                    ...
                                    <asp:TableRow ID="TableRow21" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell3" runat="server" Width="150px" HorizontalAlign="Left"
                                            CssClass="tabCell">
                                            <asp:CheckBox ID="cbShowRetired" runat="server" AutoPostBack="true" OnCheckedChanged="cbShowRetired_CheckedChanged"  CssClass="contentLblLeft"/>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow24" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell50" runat="server" Width="150px" HorizontalAlign="Left"
                                            CssClass="tabCell">
                                            <asp:Label ID="lblBorderDate" runat="server" Width="140px" CssClass="contentLblLeft"></asp:Label>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow28" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell51" runat="server" Width="150px" HorizontalAlign="Left">
                                            <asp:Table ID="Table21" runat="server" Width="140px" CssClass="tabNoBorderTable">
                                                <asp:TableRow ID="TableRow33" runat="server" Width="140px">
                                                    <asp:TableCell ID="TableCell25" runat="server" Width="110px" CssClass="tabCell">
                                                        <asp:TextBox ID="tbBorderDate" runat="server" Width="80px" AutoPostBack = "true" OnTextChanged="Date_Changed" CssClass="contentTb"></asp:TextBox>
                                                    </asp:TableCell>
                                                    <asp:TableCell ID="TableCell26" runat="server" Width="30px" CssClass="tabCell">
                                                        <asp:ImageButton ID="btnBorderDate" runat="server" Visible="false" ImageUrl="/ACTAWeb/CommonWeb/images/calendar.gif"
                                                            CssClass="contentImgBtn"></asp:ImageButton>
                                                            <asp:Calendar ID="calendarBorder" runat="server" OnSelectionChanged="DataBorderChange" FirstDayOfWeek="Monday" CssClass="calendar" ShowGridLines="true" Visible="false">
                                                            ...
                                                            <asp:ImageButton ID="btnBorder" ImageUrl="/ACTAWeb/CommonWeb/images/calendar.gif"  runat="server" OnClick="ShowCalendarBorder" />
                                                    </asp:TableCell>
                                                </asp:TableRow>
                                            </asp:Table>
                                        </asp:TableCell>
                                ...
                                <asp:Table ID="Table20" runat="server" Width="150px" CssClass="tabTable">
                                    <asp:TableRow ID="TableRow35" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell59" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Label ID="lblAnomalyCategory" runat="server" Width="140px" CssClass="contentLblLeft"></asp:Label>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow34" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell60" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:ListBox ID="lbAnomalies" runat="server" Width="140px" Height="55px" SelectionMode="Multiple"
                                                CssClass="contentLb"></asp:ListBox>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow23" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell21" runat="server" Width="150px" HorizontalAlign="Left" CssClass="tabCell">
                                            <asp:CheckBox ID="chbHoursDiff" runat="server" CssClass="contentChb" />                                            
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow22" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell23" runat="server" Width="150px" HorizontalAlign="Left" CssClass="tabCell">
                                            <asp:RadioButton ID="rbStandard" runat="server" OnCheckedChanged="rbStandard_ChackedChanged" AutoPostBack="true" CssClass="contentRbSmall" />
                                            <asp:RadioButton ID="rbHoursDiff" runat="server" OnCheckedChanged="rbHoursDiff_ChackedChanged" AutoPostBack="true" CssClass="contentRbSmall" />
                                        </asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </asp:TableCell>
                                            ...
                                            <asp:Table ID="Table18" runat="server" Width="140px" CssClass="tabNoBorderTable">                                                
                                                ...
                                                <asp:TableRow ID="TableRow31" runat="server" Width="140px">
                                                    ...
                                                    <asp:TableCell ID="TableCell57" runat="server" Width="30px" CssClass="tabCell">
                                                        <asp:ImageButton ID="btnToDate" Visible="false" runat="server" ImageUrl="/ACTAWeb/CommonWeb/images/calendar.gif"
                                                            CssClass="contentImgBtn"></asp:ImageButton>
                        ...
                        <asp:TableRow ID="TableRow20" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell49" runat="server" Width="1000px" CssClass="tabCell">
                                <iframe id="resultIFrame" runat="server" frameborder="0" scrolling="auto" marginheight="0px"
                                    marginwidth="0px" height="525px" class="pageIframe"></iframe>
                            </asp:TableCell>
                        </asp:TableRow>
                ...
                <asp:TableCell ID="TableCell4" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table14" runat="server" Width="1000px" CssClass="tabTable">
                        <asp:TableRow ID="TableRow25" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell41" runat="server" Width="1000px" HorizontalAlign="Center" CssClass="tabMidAlignCell">
