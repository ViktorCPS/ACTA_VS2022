<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmplWeightHeightPage.aspx.cs" Inherits="ACTAWebUI.EmplWeightHeightPage" %>
        ...
        <asp:Table ID="Table15" runat="server" Width="990px" CssClass="tabNoBorderTable">
            ...
            <asp:TableRow ID="TableRow8" runat="server" Width="990px">
                <asp:TableCell ID="TableCell19" runat="server" Width="990px" CssClass="tabMidAlignCell">
                    <asp:Label ID="lblNewEntry" runat="server" Width="200px" CssClass="contentLblLeft"></asp:Label>
                    <asp:Label ID="lblInfo" runat="server" Width="780px" CssClass="contentInfoLblRight"></asp:Label>
                </asp:TableCell>                
            </asp:TableRow>
                                ...
                                <asp:Table ID="Table2" runat="server" Width="970px" CssClass="tabNoBorderTable">
                                    <asp:TableRow ID="TableRow7" runat="server" Width="970px">
                                        ...
                                        <asp:TableCell ID="TableCell11" runat="server" Width="85px" CssClass="tabMidAlignCell">
                                            <asp:Label ID="lblWeight" runat="server" Width="70px" CssClass="contentLblLeft"></asp:Label>
                                        </asp:TableCell>
                                        <asp:TableCell ID="TableCell15" runat="server" Width="30px" CssClass="tabMidAlignCell"></asp:TableCell>
                                        <asp:TableCell ID="TableCell16" runat="server" Width="85px" CssClass="tabMidAlignCell">
                                            <asp:Label ID="lblHeight" runat="server" Width="70px" CssClass="contentLblLeft"></asp:Label>
                                        </asp:TableCell>
                                        <asp:TableCell ID="TableCell3" runat="server" Width="30px" CssClass="tabMidAlignCell"></asp:TableCell>
                                        <asp:TableCell ID="TableCell17" runat="server" Width="310px" CssClass="tabMidAlignCell"></asp:TableCell>
                                        <asp:TableCell ID="TableCell14" runat="server" Width="310px" CssClass="tabMidAlignCell"></asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow6" runat="server" Width="990px">
                                        ...
                                        <asp:TableCell ID="TableCell4" runat="server" Width="85px" CssClass="tabMidAlignCell">
                                            <asp:TextBox ID="tbWeight" runat="server" Width="70px" CssClass="contentTb"></asp:TextBox>
                                        </asp:TableCell>                                                    
                                        <asp:TableCell ID="TableCell9" runat="server" Width="30px" HorizontalAlign="Left" CssClass="tabMidAlignCell">
                                            <asp:Label ID="lblKg" runat="server" Width="20px" Text="kg" CssClass="contentLblLeft"></asp:Label>
                                        </asp:TableCell>
                                        <asp:TableCell ID="TableCell12" runat="server" Width="85px" CssClass="tabMidAlignCell">
                                            <asp:TextBox ID="tbHeight" runat="server" Width="70px" CssClass="contentTb"></asp:TextBox>
                                        </asp:TableCell>
                                        <asp:TableCell ID="TableCell13" runat="server" Width="30px" HorizontalAlign="Left" CssClass="tabMidAlignCell">
                                            <asp:Label ID="lblCm" runat="server" Width="20px" Text="cm" CssClass="contentLblLeft"></asp:Label>
                                        </asp:TableCell>
                                        <asp:TableCell ID="TableCell7" runat="server" Width="310px" HorizontalAlign="Center" CssClass="tabMidAlignCell">
                                            <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" CssClass="contentBtn"></asp:Button>                                            
                                        </asp:TableCell>
                                        <asp:TableCell ID="TableCell8" runat="server" Width="310px" HorizontalAlign="Center" CssClass="tabMidAlignCell">
