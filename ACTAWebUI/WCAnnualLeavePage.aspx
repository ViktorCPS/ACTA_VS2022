<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WCAnnualLeavePage.aspx.cs" Inherits="ACTAWebUI.WCAnnualLeavePage" %>
                    ...
                    <asp:Table ID="Table6" runat="server" Width="150px" CssClass="tabNoBorderTable">
                                    ...
                                    <asp:TableRow ID="TableRow8" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell11" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Panel ID="emplDataPanel" runat="server" Width="140px" Height="300px" ScrollBars="Auto" CssClass="resultPanel">
                                                <asp:Table ID="Table4" runat="server" Width="120px" CssClass="tabNoBorderTable">                                            
                                                    <asp:TableRow ID="TableRow48" runat="server" Width="120px">
                                                        <asp:TableCell ID="TableCell3" runat="server" Width="120px" CssClass="tabCell">
                                                            <asp:Label ID="lblFirstName" runat="server" Width="105px" CssClass="contentLblLeft"></asp:Label>                                            
                                                        </asp:TableCell>
                                                    </asp:TableRow>
                                                    <asp:TableRow ID="TableRow4" runat="server" Width="120px">
                                                    ...
                                                    <asp:TableRow ID="TableRow140" runat="server" Width="120px">
                                                    ...
                                                    <asp:TableRow ID="TableRow29" runat="server" Width="120px">
                                                        <asp:TableCell ID="TableCell7" runat="server" Width="120px" CssClass="tabCell">
                                                    ...
                                                    <asp:TableRow ID="TableRow5" runat="server" Width="120px">
                                                    ...
                                                    <asp:TableRow ID="TableRow14" runat="server" Width="120px">
                                                        <asp:TableCell ID="TableCell22" runat="server" Width="120px" CssClass="tabCell">
                                ...
                                <asp:Table ID="Table20" runat="server" Width="150px" CssClass="tabTable">
                                    ...
                                    <asp:TableRow ID="TableRow11" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell13" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:DropDownList ID="cbPassType" runat="server" OnSelectedIndexChanged="cbPassType_SelectedIndexChanged" Width="140px" CssClass="contentDDList"></asp:DropDownList>
                                        </asp:TableCell>
                                    </asp:TableRow>                                    
                                </asp:Table>
                            </asp:TableCell>
                                        ...
                                        <asp:TableCell ID="TableCell14" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Table ID="Table5" runat="server" Width="140px" CssClass="tabNoBorderTable">
                                                <asp:TableRow ID="TableRow13" runat="server" Width="140px">
                                                    <asp:TableCell ID="TableCell15" runat="server" HorizontalAlign="Center" Width="25px" CssClass="tabCell">
                                                    ...
                                                    <asp:TableCell ID="TableCell21" runat="server" HorizontalAlign="Center" Width="25px" CssClass="tabCell">
                        ...
                        <asp:TableRow ID="TableRow36" runat="server" Width="150px">
                            <asp:TableCell ID="TableCell31" runat="server" Width="150px" CssClass="tabCell">
                                <asp:Table ID="Table2" runat="server" Width="140px" CssClass="tabNoBorderTable">
                                    ...
                                    <asp:TableRow ID="TableRow35" runat="server" Width="140px">
                                        <asp:TableCell ID="TableCell34" runat="server" Width="140px" CssClass="tabCell">
                                            <asp:Table ID="Table9" runat="server" Width="140px" CssClass="tabNoBorderTable">
                                                <asp:TableRow ID="TableRow27" runat="server" Width="140px">
                                                    <asp:TableCell ID="TableCell28" runat="server" Width="65px" CssClass="tabMidAlignCell">
                                                        <asp:RadioButton ID="rbNo" runat="server" CssClass="contentRb" />
                                                    </asp:TableCell>
                                                    <asp:TableCell ID="TableCell30" runat="server" Width="65px" CssClass="tabMidAlignCell">
                ...
                <asp:TableCell ID="TableCell4" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table14" runat="server" Width="1000px" CssClass="tabTable">
                        <asp:TableRow ID="TableRow25" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell25" runat="server" Width="400px" HorizontalAlign="Left"
                                CssClass="tabMidAlignCell">
                                <asp:CheckBox ID="chbReport" runat="server" CssClass="contentLblLeft" />
                            </asp:TableCell>                           
                            <asp:TableCell ID="TableCell23" runat="server" Width="300px" HorizontalAlign="Center" CssClass="tabMidAlignCell">
                                <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" CssClass="contentBtn"></asp:Button>
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell232" runat="server" Width="300px" HorizontalAlign="Right"
                                CssClass="tabMidAlignCell">
                             <asp:Button ID="btnPrint" runat="server" OnClick="btnPrint_Click" CssClass="contentBtn">
                                </asp:Button>
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
