<%@ Page Language="C#" Culture="en-US" UICulture="sr-Latn-CS" AutoEventWireup="true" CodeBehind="TLWUStatisticalReportsPage.aspx.cs"
    Inherits="ACTAWebUI.WUStatisticalReportsPage" %>

<%@ Register Namespace="System.Drawing.PieChart.WebControl" Assembly="PieChart3DWebcontrol"
    TagPrefix="cnt" %> 
    ...
    <div>
                                ...
                                <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                                    <asp:View ID="tabWU" runat="server">
                                        <asp:Table ID="Table4" runat="server" Width="150px" CssClass="tabTable">
                                            <asp:TableRow ID="TableRow44" runat="server" Width="150px">
                                            ...
                                            <asp:TableRow ID="TableRow49" runat="server" Width="150px">
                                                <asp:TableCell ID="TableCell4" runat="server" Width="150px" HorizontalAlign="Center"
                                                    CssClass="tabCell">
                                ...
                                <asp:Table ID="Table7" runat="server" Width="150px" CssClass="tabTable">
                                    <asp:TableRow ID="TableRow12" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell14" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Label ID="lblUTE" runat="server" Width="140px" CssClass="contentLblLeft"></asp:Label>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow13" runat="server" Width="150px">
                                        <asp:TableCell>
                                            <asp:RadioButton runat="server" ID="rbSingle" Checked="True" OnCheckedChanged="rb_CheckedChanged"
                                                AutoPostBack="true" CssClass="contentRb"></asp:RadioButton>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow4" runat="server" Width="150px">
                                        <asp:TableCell>
                                            <asp:RadioButton runat="server" ID="rbMultiple" OnCheckedChanged="rb_CheckedChanged"
                                                AutoPostBack="true" CssClass="contentRb"></asp:RadioButton>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow14" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell16" runat="server" Width="150px" HorizontalAlign="Left"
                                            CssClass="tabCell">
                                            <asp:ListBox ID="lboxUTE" runat="server" Width="140px" Height="120px" SelectionMode="Multiple"
                                ...
                                <asp:Table ID="Table20" runat="server" Width="150px" CssClass="tabTable">
                                    ...
                                    <asp:TableRow ID="TableRow34" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell60" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:ListBox runat="server" Width="140px" Height="90px" SelectionMode="Multiple"
                                        ...
                                        <asp:TableCell ID="TableCell19" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Table ID="Table18" runat="server" Width="140px" CssClass="tabNoBorderTable">
                                                <asp:TableRow ID="TableRow18" runat="server" Width="140px">
                                                    <asp:TableCell ID="TableCell20" runat="server" Width="110px" CssClass="tabCell">
                                                        <asp:Label ID="lblFrom" runat="server" Width="100px" CssClass="contentLblLeft"></asp:Label>
                                                    </asp:TableCell>                                                    
                                                ...
                                                <asp:TableRow ID="TableRow29" runat="server" Width="150px">
                                                    <asp:TableCell ID="TableCell32" runat="server" Width="110px" CssClass="tabCell">
                                                        <asp:TextBox ID="tbFromDate" runat="server" Width="100px" CssClass="contentTb"></asp:TextBox>
                                                    </asp:TableCell>
                                                ...
                                                <asp:TableRow ID="TableRow30" runat="server" Width="150px">
                                                    <asp:TableCell ID="TableCell45" runat="server" Width="110px" CssClass="tabCell">
                                                        <asp:Label ID="lblTo" runat="server" Width="100px" CssClass="contentLblLeft"></asp:Label>
                                                    </asp:TableCell>                                                    
                                                ...
                                                <asp:TableRow ID="TableRow31" runat="server" Width="150px">
                                                    <asp:TableCell ID="TableCell48" runat="server" Width="110px" CssClass="tabCell">
                                                        <asp:TextBox ID="tbToDate" runat="server" Width="100px" CssClass="contentTb"></asp:TextBox>
                                                    </asp:TableCell>
                ...
                <asp:TableCell ID="TableCell2" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table10" runat="server" Width="1000px" CssClass="tabNoBorderTable">
                        <asp:TableRow ID="TableRow20" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell8" runat="server" Width="1000px" HorizontalAlign="Center"
        ...
        <asp:Table ID="Table15" runat="server" Width="1180px" CssClass="tabNoBorderTable">
            <asp:TableRow ID="TableRow2" runat="server" Width="1180px">
                ...
                <asp:TableCell ID="TableCell55" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table145" runat="server" Width="1000px" CssClass="tabTable">
                        <asp:TableRow ID="TableRow255" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell415" runat="server" Width="500px" HorizontalAlign="Center"
                                CssClass="tabMidAlignCell">
