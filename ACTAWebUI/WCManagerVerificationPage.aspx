<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WCManagerVerificationPage.aspx.cs" Inherits="ACTAWebUI.WCManagerVerificationPage" %>
                            ...
                            <asp:TableCell ID="TableCell13" runat="server" Width="150px" CssClass="tabCell">
                                <asp:Table ID="Table7" runat="server" Width="150px" CssClass="tabTable">
                                    <asp:TableRow ID="TableRow18" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell22" runat="server" Width="150px" CssClass="tabMidAlignCell">
                                    ...
                                    <asp:TableRow ID="TableRow38" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell36" runat="server" Width="150px" CssClass="tabMidAlignCell">
                                ...
                                <asp:Table ID="Table20" runat="server" Width="150px" CssClass="tabTable">
                                    ...
                                    <asp:TableRow ID="TableRow34" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell60" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:ListBox ID="lbPassTypes" runat="server" Width="140px" Height="70px" SelectionMode="Multiple" OnPreRender="lbPassTypes_PreRender"
                            ...
                            <asp:TableCell ID="TableCell17" runat="server" Width="150px" CssClass="tabCell">
                                <asp:Table ID="Table8" runat="server" Width="150px" CssClass="tabTable">
                                    ...
                                    <asp:TableRow ID="TableRow28" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell29" runat="server" Width="150px" CssClass="tabCell">
                                                ...
                                                <asp:TableRow ID="TableRow29" runat="server" Width="140px">
                                                    ...
                                                    <asp:TableCell ID="TableCell44" runat="server" Width="30px" CssClass="tabCell">
                                                        <asp:ImageButton ID="btnFromDate" Visible="false" runat="server" ImageUrl="/ACTAWeb/CommonWeb/images/calendar.gif"
                                                            CssClass="contentImgBtn"></asp:ImageButton>
                                                            <asp:ImageButton ID="ImageButton1" runat="server" Visible="false" ImageUrl="/ACTAWeb/CommonWeb/images/calendar.gif"
                                                            CssClass="contentImgBtn"></asp:ImageButton>
                ...
                <asp:TableCell ID="TableCell4" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table14" runat="server" Width="1000px" CssClass="tabTable">
                        <asp:TableRow ID="TableRow25" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell28" runat="server" Width="150px" CssClass="tabMidAlignCell">
                                <asp:RadioButton ID="rbVerification" runat="server" AutoPostBack="true" OnCheckedChanged="rbVerification_CheckedChanged" CssClass="contentRb" />
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell26" runat="server" Width="150px" CssClass="tabMidAlignCell">
                                <asp:RadioButton ID="rbUndoVerification" runat="server" AutoPostBack="true" OnCheckedChanged="rbUndoVerification_CheckedChanged" CssClass="contentRb" />
                            </asp:TableCell> 
                            <asp:TableCell ID="TableCell27" runat="server" Width="500px" CssClass="tabMidAlignCell">
                                <asp:Label ID="lblHelp" runat="server" Width="480px" CssClass="contentHelpLbl"></asp:Label>                                
                            </asp:TableCell>
