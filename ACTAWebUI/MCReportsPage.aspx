<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MCReportsPage.aspx.cs" Inherits="ACTAWebUI.MCReportsPage" %>
...
<body>
    ...
    <div>
        <asp:Label ID="lblInfo" runat="server" Text="TO BE DONE" CssClass="hdrTitle"></asp:Label>
    </div>
    </form>
</body>
</html>
