<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WCDetailsPage.aspx.cs"
    Inherits="ACTAWebUI.WCDetailsPage" %>
    ...
    <div>
        <asp:Table ID="Table1" runat="server" Width="1180px" CssClass="tabNoBorderTable">
            <asp:TableRow ID="TableRow1" runat="server" Width="1180px">
                <asp:TableCell ID="TableCell5" runat="server" Width="150px" CssClass="tabCell">
                    <asp:Table ID="Table6" runat="server" Width="150px" CssClass="tabNoBorderTable">
                        <asp:TableRow ID="TableRow6" runat="server" Width="150px">
                            <asp:TableCell ID="TableCell678" runat="server" Width="150px" CssClass="tabCell">
                                            ...
                                            <asp:Panel ID="emplDataPanel" runat="server" Width="140px" Height="230px" ScrollBars="Auto" CssClass="resultPanel">
                                                <asp:Table ID="Table3" runat="server" Width="120px" CssClass="tabNoBorderTable">                                            
                                                    <asp:TableRow ID="TableRow48" runat="server" Width="120px">
                                                        <asp:TableCell ID="TableCell1" runat="server" Width="120px" CssClass="tabCell">
                                                    ...
                                                    <asp:TableRow ID="rowWUlbl" runat="server" Width="120px">
                                                        <asp:TableCell ID="TableCell6" runat="server" Width="120px" CssClass="tabCell">
                                                    ...
                                                    <asp:TableRow ID="TableRow300" runat="server" Width="120px">
                                                        <asp:TableCell ID="TableCell13" runat="server" Width="120px" CssClass="tabCell">
                            ...
                            <asp:TableCell ID="TableCell3" runat="server" Width="150px" CssClass="tabCell">
                                <asp:Table ID="Table20" runat="server" Width="150px" CssClass="tabTable">
                                    <asp:TableRow ID="TableRow7" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell4" runat="server" Width="150px" CssClass="tabCell">
                                    ...
                                    <asp:TableRow ID="TableRow8" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell12" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:ListBox runat="server" Width="140px" Height="80px" SelectionMode="Multiple" OnPreRender="lbPassTypes_PreRender"
                                                CssClass="contentLb" ID="lbPassTypes"></asp:ListBox>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </asp:TableCell>
                                    ...
                                    <asp:TableRow ID="TableRow17" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell19" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Table ID="Table18" runat="server" Width="140px" CssClass="tabNoBorderTable">
                                                ...
                                                <asp:TableRow ID="TableRow12" runat="server" Width="140px">
                                                ...
                                                <asp:TableRow ID="TableRow13" runat="server" Width="140px">
                                                    ...
                                                    <asp:TableCell ID="TableCell15" runat="server" Width="30px" CssClass="tabCell">
        ...
        <asp:Table ID="Table15" runat="server" Width="1180px" CssClass="tabNoBorderTable">
            <asp:TableRow ID="TableRow9" runat="server" Width="1180px">
                ...
                <asp:TableCell ID="TableCell11" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table14" runat="server" Width="1000px" CssClass="tabTable">
                        <asp:TableRow ID="TableRow25" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell14" runat="server" Width="500px" CssClass="tabLeftAlignCell">
                                <asp:CheckBox ID="cbMontlyTotals" runat="server" CssClass="contentLblLeft" />
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell41" runat="server" Width="500px" CssClass="tabMidAlignCell">
