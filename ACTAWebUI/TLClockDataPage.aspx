<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TLClockDataPage.aspx.cs"
    Inherits="ACTAWebUI.TLClockDataPage" %>
                                ...
                                <asp:Table ID="Table20" runat="server" Width="150px" CssClass="tabTable">
                                    ...
                                    <asp:TableRow ID="TableRow34" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell60" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:ListBox ID="lbGates" runat="server" Width="140px" Height="60px" SelectionMode="Multiple"
                                    ...
                                    <asp:TableRow ID="TableRow22" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell23" runat="server" Width="150px" HorizontalAlign="Left"
                                            CssClass="tabCell">
                                            <asp:CheckBox ID="cbSelectGates" runat="server" CssClass="contentLblLeft"/>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </asp:TableCell>
                    ...
                    <asp:Table ID="Table14" runat="server" Width="1000px" CssClass="tabTable">
                        <asp:TableRow ID="TableRow25" runat="server" Width="1000px">
                           <asp:TableCell ID="TableCell42" runat="server" Width="450px" CssClass="tabMidAlignCell"
                            ...
                            <asp:TableCell ID="TableCell25" runat="server" Width="500px" HorizontalAlign="Center" CssClass="tabMidAlignCell">
                                <asp:Button ID="btnMap" runat="server" OnClick="btnMap_Click" CssClass="contentBtn"></asp:Button>
