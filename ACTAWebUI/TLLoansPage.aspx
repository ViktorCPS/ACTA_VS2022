<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TLLoansPage.aspx.cs" Inherits="ACTAWebUI.TLLoansPage" %>
                                        ...
                                        <asp:Table ID="Table4" runat="server" Width="150px" CssClass="tabTable">
                                            <asp:TableRow ID="TableRow4" runat="server" Width="150px">
                                                <asp:TableCell ID="TableCell7" runat="server" Width="150px" CssClass="tabCell">
                                                    <asp:TextBox ID="tbWorkshop" runat="server" Width="130px" ReadOnly="true" CssClass="contentTbDisabled"></asp:TextBox>
                                                </asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow ID="TableRow5" runat="server" Width="150px">
                                                <asp:TableCell ID="TableCell8" runat="server" Width="150px" CssClass="tabCell">
                                                    <asp:TextBox ID="tbUte" runat="server" Width="130px" ReadOnly="true" CssClass="contentTbDisabled"></asp:TextBox>
                                                </asp:TableCell>
                                            </asp:TableRow>
                                        ...
                                        <asp:Table ID="Table5" runat="server" Width="150px" CssClass="tabTable">
                                            ...
                                            <asp:TableRow ID="TableRow10" runat="server" Width="150px">
                                                <asp:TableCell ID="TableCell11" runat="server" Width="150px" CssClass="tabCell">
                                                    <asp:TextBox ID="tbOrgUte" runat="server" Width="130px" ReadOnly="true" CssClass="contentTbDisabled"></asp:TextBox>
                                                </asp:TableCell>
                                            </asp:TableRow>
                                ...
                                <asp:Table ID="Table7" runat="server" Width="150px" CssClass="tabTable">
                                    ...
                                    <asp:TableRow ID="TableRow14" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell16" runat="server" Width="150px" HorizontalAlign="Left"
                                            CssClass="tabCell">
                                            <asp:ListBox ID="lboxEmployees" runat="server" Width="140px" SelectionMode="Multiple" OnPreRender="lboxEmployees_PreRender"
                                                Height="160px" CssClass="contentLblLeft"></asp:ListBox>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                ...
                                <asp:Table ID="Table2" runat="server" Width="150px" CssClass="tabTable">
                                    <asp:TableRow ID="TableRow28" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell21" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Label ID="lblTempUTE" runat="server" Width="140px" CssClass="contentLblLeft"></asp:Label>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow23" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell25" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:TextBox Visible=false ID="tbTempUte" runat="server" Width="130px" ReadOnly="true" CssClass="contentTbDisabled"></asp:TextBox>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow24" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell26" runat="server" Width="150px" HorizontalAlign="Center"
                                            CssClass="tabCell">
                                            <asp:ImageButton Visible=false ID="btnTempWUTree" runat="server" ImageUrl="/ACTAWeb/CommonWeb/images/treeButton.png"
                                                CssClass="contentImgBtn"></asp:ImageButton>
                                                <asp:DropDownList ID="dropDownWU"  OnSelectedIndexChanged="dropDownWU_ItemChanged" runat="server" Width="150px"></asp:DropDownList>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </asp:TableCell>
        ...
        <asp:Table ID="Table15" runat="server" Width="1180px" CssClass="tabNoBorderTable">
            <asp:TableRow ID="TableRow2" runat="server" Width="1180px">
                <asp:TableCell ID="TableCell151" runat="server" Width="155px" HorizontalAlign="Center"
                    ...
                    <asp:Table ID="Table3" runat="server" Width="150px" CssClass="tabTable">
                        <asp:TableRow ID="TableRow3" runat="server" Width="150px">
                            <asp:TableCell ID="TableCell5" runat="server" Width="75px" HorizontalAlign="Center"
                                CssClass="tabMidAlignCell">
                                <asp:RadioButton ID="rbMove" runat="server" OnCheckedChanged="rbMove_CheckedChanged"
                                    AutoPostBack="true" CssClass="contentRb" />
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell28" runat="server" Width="75px" HorizontalAlign="Center"
                                CssClass="tabMidAlignCell">
                                <asp:RadioButton ID="rbShow" runat="server" OnCheckedChanged="rbShow_CheckedChanged"
                                    AutoPostBack="true" CssClass="contentRb" />
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow ID="TableRow22" runat="server" Width="150px">
                            <asp:TableCell ID="TableCell27" runat="server" Width="75px" HorizontalAlign="Left"
                                CssClass="tabMidAlignCell">
                                <asp:Button ID="btnShow" runat="server" OnClick="btnShow_Click" CssClass="contentBtn">
                                </asp:Button>
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell24" runat="server" Width="75px" HorizontalAlign="Center"
                                CssClass="tabMidAlignCell">                                
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                ...
                <asp:TableCell ID="TableCell4" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table14" runat="server" Width="1000px" CssClass="tabNoBorderTable">
                        <asp:TableRow ID="TableRow19" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell29" runat="server" Width="1000px" CssClass="tabCell">
                                <asp:Table ID="Table9" runat="server" Width="1000px" CssClass="tabNoBorderTable">
                                    <asp:TableRow ID="TableRow26" runat="server" Width="1000px">
                                        <asp:TableCell ID="TableCell30" runat="server" Width="1000px" CssClass="tabCell">
                        ...
                        <asp:TableRow ID="TableRow25" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell31" runat="server" Width="1000px" CssClass="tabCell">
                                <asp:Table ID="Table11" runat="server" Width="1000px" CssClass="tabTable">
                                    <asp:TableRow ID="TableRow27" runat="server" Width="1000px">
                                        <asp:TableCell ID="TableCell41" runat="server" Width="500px" HorizontalAlign="Center"
                                            CssClass="tabMidAlignCell">
                                            <asp:Button ID="btnReport" runat="server" OnClick="btnReport_Click" CssClass="contentBtn">
                                            </asp:Button>
                                        </asp:TableCell>
                                        <asp:TableCell ID="TableCell23" runat="server" Width="500px" HorizontalAlign="Center"
                                            CssClass="tabMidAlignCell">
                                            <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" CssClass="contentBtn">
                                            </asp:Button>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
