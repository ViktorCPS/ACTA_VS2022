<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MCVisitsSearchPage.aspx.cs" Inherits="ACTAWebUI.MCVisitsSearchPage" %>
    ...
    <div>
        <asp:Table ID="Table1" runat="server" Width="1180px" CssClass="tabNoBorderTable">
            <asp:TableRow ID="TableRow1" runat="server" Width="1180px">
                    ...
                    <asp:Table ID="Table6" runat="server" Width="150px" CssClass="tabNoBorderTable">
                                ...
                                <asp:Table ID="Table7" runat="server" Width="150px" CssClass="tabTable">                                    
                                    ...
                                    <asp:TableRow ID="TableRow14" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell16" runat="server" Width="150px" HorizontalAlign="Left"
                                            CssClass="tabCell">
                                            <asp:ListBox ID="lboxEmployees" runat="server" Width="140px" SelectionMode="Multiple" OnPreRender="lboxEmployees_PreRender" Height="80px" CssClass="contentLblLeft">
                                            </asp:ListBox>
                                        </asp:TableCell>
                                    </asp:TableRow>                                    
                                </asp:Table>
                        ...
                        <asp:TableRow ID="TableRow15" runat="server" Width="150px">
                            <asp:TableCell ID="TableCell17" runat="server" Width="150px" CssClass="tabCell">
                                <asp:Table ID="tablePeriod" runat="server" Width="150px" CssClass="tabTable">
                                        ...
                                        <asp:TableCell ID="TableCell27" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Table ID="Table11" runat="server" Width="140px" CssClass="tabNoBorderTable">
                                                <asp:TableRow ID="TableRow21" runat="server" Width="140px">
                                                    ...
                                                    <asp:TableCell ID="TableCell3" runat="server" HorizontalAlign="Center" Width="25px" CssClass="tabCell">
                        ...
                        <asp:TableRow ID="TableRow32" runat="server" Width="150px">
                            <asp:TableCell ID="TableCell58" runat="server" Width="150px" CssClass="tabCell">
                                <asp:Table ID="tableStatus" runat="server" Width="150px" CssClass="tabTable">
                                    ...
                                    <asp:TableRow ID="TableRow34" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell60" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:ListBox ID="lbStatus" runat="server" Width="140px" Height="70px" SelectionMode="Multiple"
                        ...
                        <asp:TableRow ID="TableRow24" runat="server" Width="150px">
                            <asp:TableCell ID="TableCell2" runat="server" Width="150px" CssClass="tabCell">
                                <asp:Table ID="tablePoint" runat="server" Width="150px" CssClass="tabTable">
                                    <asp:TableRow ID="TableRow40" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell22" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Label ID="lblPoint" runat="server" Width="140px" CssClass="contentLblLeft"></asp:Label>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow41" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell24" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:ListBox ID="lbPoint" runat="server" Width="140px" Height="40px" SelectionMode="Multiple"
                                                CssClass="contentLb"></asp:ListBox>
                                        </asp:TableCell>
                                    </asp:TableRow>                                    
                                </asp:Table>
                ...
                <asp:TableCell ID="TableCell70" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table10" runat="server" Width="1000px" CssClass="tabNoBorderTable">
                            ...
                            <asp:TableCell ID="TableCell38" runat="server" Width="1000px" CssClass="tabCell">
                                <asp:Table ID="Table16" runat="server" Width="1000px" CssClass="tabNoBorderTable">
                                    <asp:TableRow ID="TableRow37" runat="server" Width="1000px">
                                        <asp:TableCell ID="TableCell71" runat="server" Width="200px" CssClass="tabCell">
                                            <asp:Table ID="Table9" runat="server" Width="200px" CssClass="tabTable">                                    
                                                <asp:TableRow ID="TableRow22" runat="server" Width="200px">
                                                    <asp:TableCell ID="TableCell25" runat="server" Width="200px" CssClass="tabCell">
                                                        <asp:RadioButton ID="rbVisits" AutoPostBack="true" OnCheckedChanged="rbVisits_CheckedChanged" runat="server" CssClass="contentRb" />
                                                    </asp:TableCell>
                                                </asp:TableRow>
                                                <asp:TableRow ID="TableRow26" runat="server" Width="200px">
                                                    <asp:TableCell ID="TableCell31" runat="server" Width="200px" CssClass="tabCell">
                                                        <asp:RadioButton ID="rbEmployeeData" AutoPostBack="true" OnCheckedChanged="rbEmployeeData_CheckedChanged" runat="server" CssClass="contentRb" />
                                                    </asp:TableCell>
                                                </asp:TableRow>
                                            </asp:Table>
                                        </asp:TableCell>
                                        <asp:TableCell ID="TableCell26" runat="server" Width="300px" CssClass="tabCell">
                                            <asp:Table ID="Table12" runat="server" Width="300px" CssClass="tabTable">
                                                <asp:TableRow ID="TableRow39" runat="server" Width="300px">
                                                    <asp:TableCell ID="TableCell52" runat="server" Width="100px" CssClass="tabCell">
                                                        <asp:Table ID="Table13" runat="server" Width="100px" CssClass="tabNoBorderTable">
                                                            <asp:TableRow ID="TableRow27" runat="server" Width="100px">
                                                                <asp:TableCell ID="TableCell29" runat="server" Width="100px" CssClass="tabCell">
                                                                    <asp:RadioButton ID="rbRisks" AutoPostBack="true" OnCheckedChanged="rbRisks_CheckedChanged" runat="server" CssClass="contentRb" />
                                                                </asp:TableCell>
                                                            </asp:TableRow>
                                                            <asp:TableRow ID="TableRow28" runat="server" Width="100px">
                                                                <asp:TableCell ID="TableCell30" runat="server" Width="100px" CssClass="tabCell">
                                                                    <asp:RadioButton ID="rbVaccines" AutoPostBack="true" OnCheckedChanged="rbVaccines_CheckedChanged" runat="server" CssClass="contentRb" />
                                                                </asp:TableCell>
                                                            </asp:TableRow>
                                                            <asp:TableRow ID="TableRow30" runat="server" Width="100px">
                                                                <asp:TableCell ID="TableCell34" runat="server" Width="100px" CssClass="tabCell">
                                                                    <asp:RadioButton ID="rbDisabilities" AutoPostBack="true" OnCheckedChanged="rbDisabilities_CheckedChanged" runat="server" CssClass="contentRb" />
                                                                </asp:TableCell>
                                                            </asp:TableRow>
                                                        </asp:Table>
                                                    </asp:TableCell>                                                
                                                    <asp:TableCell ID="TableCell33" runat="server" Width="200px" CssClass="tabCell">
                                                        <asp:Table ID="Table19" runat="server" Width="200px" CssClass="tabNoBorderTable">
                                                            <asp:TableRow ID="TableRow35" runat="server" Width="200px">
                                                                <asp:TableCell ID="TableCell36" runat="server" Width="200px" CssClass="tabCell">
                                                                    <asp:ListBox ID="lbAddData" runat="server" Width="180px" Height="65px" OnPreRender="lbAddData_PreRender" SelectionMode="Multiple"
                                                                        CssClass="contentLb"></asp:ListBox>
                                                                </asp:TableCell>
                                                            </asp:TableRow>                                                            
                                                        </asp:Table>
                                        ...
                                        <asp:TableCell ID="TableCell37" runat="server" Width="500px" CssClass="tabCell"></asp:TableCell>                                        
                                    </asp:TableRow>
                                </asp:Table>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow ID="TableRow23" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell150" runat="server" Width="1000px" CssClass="tabCell">
                                <asp:Table ID="Table2" runat="server" Width="1000px" CssClass="tabTable">                                    
                                    ...
                                    marginwidth="0px" height="430px" class="pageIframe"></iframe>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </asp:TableCell>
                        ...
                        <asp:TableRow ID="TableRow19" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell20" runat="server" Width="1000px" CssClass="tabCell">
                ...
                <asp:TableCell ID="TableCell4" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table14" runat="server" Width="1000px" CssClass="tabTable">
                        <asp:TableRow ID="TableRow25" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell39" runat="server" Width="300px" HorizontalAlign="Center" CssClass="tabMidAlignCell">
                                <asp:Button ID="btnPersonalData" runat="server" OnClick="btnPersonalData_Click" CssClass="contentBtn"></asp:Button>
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell23" runat="server" Width="700px" HorizontalAlign="Center" CssClass="tabMidAlignCell">
