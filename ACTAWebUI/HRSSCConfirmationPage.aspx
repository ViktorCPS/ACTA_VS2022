<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRSSCConfirmationPage.aspx.cs" Inherits="ACTAWebUI.HRSSCConfirmationPage" %>
                                ...
                                <asp:Table ID="Table20" runat="server" Width="150px" CssClass="tabTable">
                                    <asp:TableRow ID="TableRow33" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell59" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Label ID="lblPassTypes" runat="server" Width="140px" CssClass="contentLblLeft"></asp:Label>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow34" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell60" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:ListBox ID="lbPassTypes" runat="server" Width="140px"  OnPreRender="lbPassTypes_PreRender" Height="70px" SelectionMode="Multiple"
                                                CssClass="contentLb"></asp:ListBox>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow ID="TableRow22" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell23" runat="server" Width="150px" HorizontalAlign="Left"
                                            CssClass="tabCell">
                                            <asp:CheckBox ID="cbSelectPassTypes" runat="server" CssClass="contentLblLeft"/>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </asp:TableCell>
                ...
                <asp:TableCell ID="TableCell2" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table10" runat="server" Width="1000px" CssClass="tabNoBorderTable">
                        ...
                        <asp:TableRow ID="TableRow19" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell21" runat="server" Width="1000px" CssClass="tabCell">
            ...
            <asp:TableRow ID="TableRow2" runat="server" Width="1180px">
                ...
                <asp:TableCell ID="TableCell4" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table14" runat="server" Width="1000px" CssClass="tabTable">
                        <asp:TableRow ID="TableRow24" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell28" runat="server" Width="300px" CssClass="tabCell">
                                <asp:Label ID="lblConfirmationPassTypes" runat="server" Width="280px" CssClass="contentLblLeft"></asp:Label>
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell29" runat="server" Width="300px" CssClass="tabCell">
                                <asp:Label ID="lblDescription" runat="server" Width="280px" CssClass="contentLblLeft"></asp:Label>
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell30" runat="server" Width="100px" CssClass="tabMidAlignCell"></asp:TableCell>
                            <asp:TableCell ID="TableCell36" runat="server" Width="160px" CssClass="tabMidAlignCell"></asp:TableCell>
                            <asp:TableCell ID="TableCell22" runat="server" Width="100px" CssClass="tabMidAlignCell"></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow ID="TableRow25" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell27" runat="server" Width="300px" CssClass="tabCell">
                                <asp:DropDownList ID="cbConfirmationPassType" runat="server" Width="280px" CssClass="contentDDList"></asp:DropDownList>
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell26" runat="server" Width="300px" CssClass="tabCell">
                                <asp:TextBox ID="tbDescription" runat="server" Width="280px" CssClass="contentTb"></asp:TextBox>
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell41" runat="server" Width="100px" CssClass="tabMidAlignCell">
                                <asp:Button ID="btnConfirmAll" runat="server" OnClick="btnConfirmAll_Click" CssClass="contentBtn"></asp:Button>
                                <input ID="selectedPairs" type="hidden" runat="server" />                              
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell37" runat="server" Width="160px" CssClass="tabMidAlignCell">
                                <asp:CheckBox ID="chbPaidLeave60" runat="server" CssClass="contentLblLeft"/>
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell412" runat="server" Width="100px" CssClass="tabMidAlignCell">
                                <asp:Button ID="btnPrint" runat="server" OnClick="btnPrint_Click" CssClass="contentBtn"></asp:Button>
                            </asp:TableCell>                            
                        </asp:TableRow>
                    </asp:Table>
                </asp:TableCell>
