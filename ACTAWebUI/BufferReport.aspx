<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BufferReport.aspx.cs" Inherits="ACTAWebUI.BufferReport" %>
                ...
                <asp:TableCell ID="TableCell1" runat="server" Width="150px" CssClass="tabCell">
                    <asp:Table ID="Table6" runat="server" Width="150px" CssClass="tabNoBorderTable">
                                ...
                                <asp:Table ID="Table7" runat="server" Width="150px" CssClass="tabTable">
                                    ...
                                    <asp:TableRow ID="TableRow14" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell16" runat="server" Width="150px" HorizontalAlign="Left"
                                            CssClass="tabCell">
                                            <asp:ListBox ID="lboxEmployees" runat="server" Width="140px" SelectionMode="Multiple" OnPreRender="lboxEmployees_PreRender" Height="150px" CssClass="contentLblLeft">
                                            </asp:ListBox>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                        ...
                                        <asp:TableCell ID="TableCell21" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Table ID="Table11" runat="server" Width="140px" CssClass="tabNoBorderTable">
                                                <asp:TableRow ID="TableRow23" runat="server" Width="140px">
                                                    <asp:TableCell ID="TableCell22" runat="server" HorizontalAlign="Center" Width="25px" CssClass="tabCell">
                                                    ...
                                                    <asp:TableCell ID="TableCell24" runat="server" HorizontalAlign="Center" Width="25px" CssClass="tabCell">
                        ...
                        <asp:TableRow ID="TableRow26" runat="server" Width="150px">
                            <asp:TableCell ID="TableCell26" runat="server" Width="150px" HorizontalAlign="Left" CssClass="tabCell">
                                <asp:CheckBox ID="cbONRecalculated" Width="140px" runat="server" CssClass="contentLblLeft"/>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow ID="TableRow27" runat="server" Width="150px">
                            <asp:TableCell ID="TableCell27" runat="server" Width="150px" HorizontalAlign="Left" CssClass="tabCell">
                                <asp:CheckBox ID="cbONCurrentMonth" Width="140px" runat="server" CssClass="contentLblLeft"/>
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                </asp:TableCell>
                    ...
                    <asp:Table ID="Table10" runat="server" Width="1000px" CssClass="tabTable">
                        ...
                        <asp:TableRow ID="TableRow24" runat="server" Width="1000px">
                            <asp:TableCell ID="TableCell25" runat="server" Width="1000px" CssClass="tabCell">
                                <asp:Label ID="lblLegend" runat="server" Width="980px" CssClass="contentLegendLbl"></asp:Label>
                            </asp:TableCell>
                        </asp:TableRow>
