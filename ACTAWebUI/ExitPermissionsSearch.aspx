<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExitPermissionsSearch.aspx.cs" Inherits="ACTAWebUI.ExitPermissionsSearch" %>
    ...
    <div>
        ...
        <asp:Table ID="Table1" runat="server" Width="1200px" HorizontalAlign="Center" CssClass="hdrTable">
            <asp:TableRow ID="TableRow1" runat="server" Width="1200px">
                <asp:TableCell ID="TableCell3" runat="server" Width="1200px" CssClass="hdrCell">
                    <asp:Label ID="lblExitPermissionsSearch" runat="server" Width="1190px" Text="Exit permissions search" CssClass="hdrTitle"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <asp:Table ID="Table2" runat="server" Width="1200px" HorizontalAlign="Center" CssClass="contentTable">
            ...
            <asp:TableRow ID="TableRow2" runat="server" Width="1200px">
                ...
                <asp:TableCell ID="TableCell16" runat="server" Width="150px" CssClass="contentCell">
                    <asp:Label ID="lblStatus" runat="server" Width="145px" Text="Status:" CssClass="contentLbl"></asp:Label>
                </asp:TableCell>
                <asp:TableCell ID="TableCell17" runat="server" Width="250px" CssClass="contentCell">
                    <asp:DropDownList ID="cbStatus" runat="server" Width="240px" AutoPostBack="false" CssClass="contentDDList"></asp:DropDownList>
                </asp:TableCell>
            ...
            <asp:TableRow ID="TableRow5" runat="server" Width="1200px">
                ...
                <asp:TableCell ID="TableCell19" runat="server" Width="150px" CssClass="contentCell">
                    <asp:Label ID="lblIssued" runat="server" Width="145px" Text="Issued:" CssClass="contentLbl"></asp:Label>
                </asp:TableCell>
                <asp:TableCell ID="TableCell20" runat="server" Width="250px" CssClass="contentCell">
                    <asp:DropDownList ID="cbIssued" runat="server" Width="240px" AutoPostBack="false" CssClass="contentDDList"></asp:DropDownList>
                </asp:TableCell>
            ...
            <asp:TableRow ID="TableRow6" runat="server" Width="1200px">
                ...
                <asp:TableCell ID="TableCell22" runat="server" Width="150px" CssClass="contentCell"></asp:TableCell>
                <asp:TableCell ID="TableCell23" runat="server" Width="250px" CssClass="contentCell"></asp:TableCell>
        ...
        <asp:Table ID="Table4" runat="server" Width="1200px" HorizontalAlign="Center" CssClass="contentTable">
            <asp:TableRow ID="TableRow10" runat="server" Width="1200px">
                <asp:TableCell ID="TableCell33" runat="server" Width="1200px" HorizontalAlign="Center" CssClass="contentCell">
                    <iframe id="resultIframe" runat="server" frameborder="0" scrolling="auto" marginheight="0px" marginwidth="0px" height="450px" class="pageIframe"></iframe>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <asp:Table ID="Table" runat="server" Width="1200px" HorizontalAlign="Center" CssClass="contentTable">
            ...
            <asp:TableRow ID="TableRow11" runat="server" Width="1200px">
                <asp:TableCell ID="TableCell42" runat="server" Width="150px" HorizontalAlign="Center" CssClass="contentCell">
                    <asp:Button ID="btnAdd" runat="server" Text="Add" OnClick="btnAdd_Click" CssClass="contentBtn"></asp:Button>
                </asp:TableCell>
                <asp:TableCell ID="TableCell41" runat="server" Width="150px" HorizontalAlign="Center" CssClass="contentCell">
                    <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="contentBtn"></asp:Button>
                </asp:TableCell>
                <asp:TableCell ID="TableCell40" runat="server" Width="150px" HorizontalAlign="Center" CssClass="contentCell">
                    <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="contentBtn"></asp:Button>
                </asp:TableCell>
                <asp:TableCell ID="TableCell34" runat="server" Width="600px" HorizontalAlign="Center" CssClass="contentCell">                                        
                    <input ID="updSelBox" type="hidden" runat="server" />
                    <input ID="delSelBox" type="hidden" runat="server" />
                </asp:TableCell>
                <asp:TableCell ID="TableCell43" runat="server" Width="150px" CssClass="contentCell">
