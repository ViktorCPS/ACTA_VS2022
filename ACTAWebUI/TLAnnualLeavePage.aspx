<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TLAnnualLeavePage.aspx.cs"
    Inherits="ACTAWebUI.TLAnnualLeavePage" %>
                                ...
                                <asp:Table ID="Table7" runat="server" Width="150px" CssClass="tabTable">
                                    ...
                                    <asp:TableRow ID="TableRow14" runat="server" Width="150px">
                                        <asp:TableCell ID="TableCell16" runat="server" Width="150px" HorizontalAlign="Left"
                                            CssClass="tabCell">
                                            <asp:ListBox ID="lboxEmployees" runat="server" Width="140px" SelectionMode="Multiple"
                                                OnPreRender="lboxEmployees_PreRender" Height="140px" CssClass="contentLblLeft">
                                            </asp:ListBox>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                        ...
                                        <asp:TableCell ID="TableCell21" runat="server" Width="150px" CssClass="tabCell">
                                            <asp:Table ID="Table11" runat="server" Width="140px" CssClass="tabNoBorderTable">
                                                <asp:TableRow ID="TableRow23" runat="server" Width="140px">
                                                    <asp:TableCell ID="TableCell22" runat="server" HorizontalAlign="Center" Width="25px"
                                                        CssClass="tabCell">
                                                    ...
                                                    <asp:TableCell ID="TableCell24" runat="server" HorizontalAlign="Center" Width="25px"
                                                        CssClass="tabCell">
                                            ...
                                            <asp:Table ID="Table18" runat="server" Width="140px" CssClass="tabNoBorderTable">
                                                <asp:TableRow ID="TableRow18" runat="server" Width="140px">
                                                    ...
                                                    <asp:TableCell ID="TableCell32" runat="server" Width="75px" CssClass="tabCell">
                                                        <asp:TextBox ID="tbFromDate" runat="server" Width="70px" AutoPostBack="true" OnTextChanged="Date_Changed"
                                                ...
                                                <asp:TableRow ID="TableRow30" runat="server" Width="140px">
                                                    ...
                                                    <asp:TableCell ID="TableCell48" runat="server" Width="75px" CssClass="tabCell">
                                                        <asp:TextBox ID="tbToDate" runat="server" Width="70px" AutoPostBack="true" OnTextChanged="Date_Changed"
                                                            CssClass="contentTb"></asp:TextBox>
                                                    </asp:TableCell>
                ...
                <asp:TableCell ID="TableCell4" runat="server" Width="1000px" CssClass="tabCell">
                    <asp:Table ID="Table14" runat="server" Width="1000px" CssClass="tabTable">
                        <asp:TableRow ID="TableRow25" runat="server" Width="1000px">
                            ...
                            <asp:TableCell ID="TableCell23" runat="server" Width="300px" HorizontalAlign="Center"
                                CssClass="tabMidAlignCell">
