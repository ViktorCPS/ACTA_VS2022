...
using ACTAReaderControlServiceWinClient.ReaderControlService;
...
namespace ACTAReaderControlServiceWinClient
{
	...
	/// </summary>
	public class ReaderControlMainForm : System.Windows.Forms.Form
    {
        ...
        // service proxy
        ReaderControlServiceClient readerControlServiceClient;

        // tray handling
        private Boolean OkToClose = false;

        // Constants
        const String APP_NAME = "ACTA Reader Control Manager";
        ...
        private Button btnAccessControlFilesStatus;
        private static bool canRefreshReaderActivities = true;

		public ReaderControlMainForm()
		{
			InitializeComponent();
            InitializeBackgoundWorkers();
            this.notifyIcon1.Icon = global::ACTAReaderControlServiceWinClient.Properties.Resources.ReaderControlStartingIcon;

			// Debug
            NotificationController.SetApplicationName("ACTAReaderControlClient");
            ...
            readerControlServiceClient = new ReaderControlServiceClient();
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ReaderControlMainForm));
            ...
            this.btnAccessControlFilesStatus = new System.Windows.Forms.Button();
            ...
            this.ctxMenu.Size = new System.Drawing.Size(278, 126);
            // 
            // openMenuItem
            // 
            this.openMenuItem.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
            this.openMenuItem.Name = "openMenuItem";
            this.openMenuItem.Size = new System.Drawing.Size(277, 22);
            ...
            this.readerControlStartToolStripMenuItem.Size = new System.Drawing.Size(277, 22);
            ...
            this.readerControlStopToolStripMenuItem.Size = new System.Drawing.Size(277, 22);
            ...
            this.notifyIcon1.Text = "ACTA Reader Control Manager";
            this.notifyIcon1.Visible = true;
            this.notifyIcon1.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.notifyIcon1_MouseDoubleClick);
            // 
            // btnAccessControlFilesStatus
            // 
            this.btnAccessControlFilesStatus.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
            this.btnAccessControlFilesStatus.Location = new System.Drawing.Point(12, 336);
            this.btnAccessControlFilesStatus.Name = "btnAccessControlFilesStatus";
            this.btnAccessControlFilesStatus.Size = new System.Drawing.Size(167, 23);
            this.btnAccessControlFilesStatus.TabIndex = 4;
            this.btnAccessControlFilesStatus.Text = "Status kontrole pristupa";
            this.btnAccessControlFilesStatus.Click += new System.EventHandler(this.btnAccessControlFilesStatus_Click);
            // 
            // ReaderControlMainForm
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(694, 407);
            this.Controls.Add(this.btnAccessControlFilesStatus);
            ...
            this.Name = "ReaderControlMainForm";
        ...
        private ArrayList CraeteReaderList()
		{
			...
			try
			{
                ...
                ReadersInfos readersInfos = readerControlServiceClient.GetReadersInfos();
				...
				if (raedersOnGate.Count > 10)
				{
                    ...
                    this.btnAccessControlFilesStatus.Location = new System.Drawing.Point(15, 300);
				}
				else
				{
                    ...
                    this.btnStartStop.Location = new System.Drawing.Point(15, 60 * raedersOnGate.Count - 55);
				}
                ...
                if (serviceStatusAvailable)
                {
                    ...
                    foreach (ReaderActivity ra in cbReaderList)
                    {
                        ...
                        if (canRefreshReaderActivities)
                        {
                            ...
                            // from reader alert handler
                            RefreshPingActivityOnReaderAlert(ra, readerStatus);
                        }
                    }
        ...
        private void RefreshPingActivityOnReaderAlert(ReaderActivity ra, ReaderStatus readerStatus)
        {
            if (readerStatus.IsPingAlertDone)
            {
                ra.SetPingAlert(readerStatus.IsNetExist);
                return;
            }
        }
        ...
        private void RefreshNotifyIcon()
        {
            if (serviceStatusAvailable)
            {
                ...
                {
                    this.notifyIcon1.Icon = global::ACTAReaderControlServiceWinClient.Properties.Resources.ReaderControlRunningIcon;
                    this.btnStartStop.Enabled = true;
                    this.statusBar.Text = "";
                }
                else
                {
                    this.notifyIcon1.Icon = global::ACTAReaderControlServiceWinClient.Properties.Resources.ReaderControlStoppedIcon;
		...
		private void btnStartStop_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (btnStartStop.Text.Trim().Equals(rm.GetString("btnStart", culture)))
				{
					...
					// Run Log Reading
					if (!readerControlServiceClient.ChekPrerequests())
					{
					...
					else
					{
                        ...
                        readerControlServiceClient.SetSelectedReaders(selectedReaders);

                        readerControlServiceClient.StartLogDownload();
				...
				else if (btnStartStop.Text.Trim().Equals(rm.GetString("btnStop", culture)))
				{
                    ...
                    readerControlServiceClient.AbortLogDownload();
        ...
        private void ReaderControlMainForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                {
                    this.timer1.Enabled = false;
                    readerControlServiceClient.Close();
        ...
        private void BackgroundRefreshService()
        {
            ...
            try
            {
                isLogDownloadStarted = readerControlServiceClient.IsLogDownloadStarted();
                readersStatuses = readerControlServiceClient.GetReadersStatuses();
        ...
        private void btnAccessControlFilesStatus_Click(object sender, EventArgs e)
        {
            try
            {
