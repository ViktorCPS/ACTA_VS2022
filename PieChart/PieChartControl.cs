...
namespace System.Drawing.PieChart {
    ...
    public class PieChartControl 
    {
        ...
        {
            get { return m_pieChart.PieSlices; }
        }
        ...
        {
            Bitmap oImg = new Bitmap(int.Parse(ClientSize.Width.ToString()), 
                int.Parse(ClientSize.Height.ToString()), System.Drawing.Imaging.PixelFormat.Format32bppArgb);
            Graphics oGraphics = Graphics.FromImage(oImg);
            DoDraw(oGraphics);
            return oImg;
        }
        /// <summary>
        ...
        protected void DoDraw(Graphics graphics) {
            if (m_values != null && m_values.Length > 0) {
                ...
                m_pieChart.Font = m_font;
                m_pieChart.ForeColor = m_foreColor;
        ...
        private float           m_sliceRelativeHeight=0.15F;
