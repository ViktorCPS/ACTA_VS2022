...
namespace Reports.Reports_sr
{
	...
	public class WorkingUnitCRViewJEEP : System.Windows.Forms.Form
	{
        ...
        public WorkingUnitCRViewJEEP(DataSet data, DateTime from, DateTime to)
		{
			...
			WorkingUnitCRJEEP_sr ecr = new WorkingUnitCRJEEP_sr();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(WorkingUnitCRView));
