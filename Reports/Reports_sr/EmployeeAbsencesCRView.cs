...
{
    public partial class EmployeeAbsencesCRView : Form
    {
      private CrystalDecisions.Windows.Forms.CrystalReportViewer crystalReportViewer;
        ...
        public EmployeeAbsencesCRView(DataSet Data,string selWorkingUnit, string selEmployee, string selPassType,string lblFootNote
            , DateTime from, DateTime to, string selUser,string totals)
		{
			//
			...
			Reports_sr.EmployeeAbsencesCR_sr  cr = new Reports_sr.EmployeeAbsencesCR_sr();
