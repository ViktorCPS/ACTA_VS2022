...
namespace Reports.Reports_sr
{
	...
	/// </summary>
	public class WorkingUnitCRView : System.Windows.Forms.Form
	{
		...
		public WorkingUnitCRView(DataSet data, DateTime from, DateTime to)
		{
			//
			...
			WorkingUnitCR_sr ecr = new WorkingUnitCR_sr();
