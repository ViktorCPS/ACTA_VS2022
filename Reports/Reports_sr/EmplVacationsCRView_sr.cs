...
{
    public partial class EmplVacationsCRView_sr : Form
    {
        ...
        public EmplVacationsCRView_sr(DataSet Data, string selWorkingUnit, string selEmployee, string selYear, string lblIncludeLast
            , string  approvedFrom,string  approvedTo, string usedFrom, string usedTo, string leftFrom, string leftTo)
		{
            ...
            Reports_sr.EmplVacationsCR_sr cr = new Reports_sr.EmplVacationsCR_sr();
