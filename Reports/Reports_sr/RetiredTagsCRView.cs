...
{
	/// <summary>
	/// Summary description for RetiredTagsCRView.
	/// </summary>
	public class RetiredTagsCRView : System.Windows.Forms.Form
	{
		...
		public RetiredTagsCRView(DataSet data)
		{
			//
			...
			RetiredTagsCR_sr ecr = new RetiredTagsCR_sr();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RetiredTagsCRView));
