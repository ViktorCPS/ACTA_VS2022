...
namespace Reports.Reports_sr
{
	...
	/// </summary>
	public class EmployeeAnalyticalCRView : System.Windows.Forms.Form
	{
		...
		public EmployeeAnalyticalCRView(DataSet Data, DateTime from, DateTime to)
		{
			//
			...
			Reports_sr.EmployeeAnalyticalCR_sr  ecr = new Reports_sr.EmployeeAnalyticalCR_sr();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EmployeeAnalyticalCRView));
