...
{
	/// <summary>
	/// Summary description for LocationsReportCRView.
	/// </summary>
	public class LocationsReportCRView : System.Windows.Forms.Form
	{
		...
		public LocationsReportCRView(DataSet data, DateTime from, DateTime to)
		{
			//
			...
			LocationsReportCR_sr ecr = new LocationsReportCR_sr();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LocationsReportCRView));
