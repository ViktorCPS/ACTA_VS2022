...
{
	/// <summary>
	/// Summary description for MittalEmplCRView_sr.
	/// </summary>
	public class MittalEmplCRView_sr : System.Windows.Forms.Form
	{
		...
		public MittalEmplCRView_sr(DataSet Data, DateTime form, DateTime to)
		{
			//
			...
			Reports.Mittal.Mittal_sr.MittalEmployeesCR_sr ecr = new MittalEmployeesCR_sr();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MittalEmplCRView_sr));
