...
{
	/// <summary>
	/// Summary description for MittalEmpoyeeAnaliticReport.
	/// </summary>
	public class MittalEmpoyeeAnaliticReport : System.Windows.Forms.Form
	{
		...
		public MittalEmpoyeeAnaliticReport()
		{	
			InitializeComponent();
		...
		private void InitializeComponent()
		{
            ...
            // lblLastName
            // 
            this.lblLastName.Location = new System.Drawing.Point(24, 32);
            ...
            // tbLastName
            // 
            this.tbLastName.Location = new System.Drawing.Point(120, 33);
            ...
            this.gbTimeInterval.Location = new System.Drawing.Point(12, 369);
            ...
            this.dtpToDate.Location = new System.Drawing.Point(120, 56);
            ...
            // lblTo
            // 
            this.lblTo.Location = new System.Drawing.Point(56, 56);
            ...
            // lblFrom
            // 
            this.lblFrom.Location = new System.Drawing.Point(56, 24);
            ...
            this.dtpFromDate.Location = new System.Drawing.Point(120, 24);
            ...
            this.lvEmployees.Location = new System.Drawing.Point(12, 137);
            ...
            this.chbCSV.Location = new System.Drawing.Point(136, 481);
            ...
            // lblDocFormat
            // 
            this.lblDocFormat.Location = new System.Drawing.Point(24, 481);
            ...
            // btnCancel
            // 
            this.btnCancel.Location = new System.Drawing.Point(393, 522);
            ...
            // btnGenerate
            // 
            this.btnGenerate.Location = new System.Drawing.Point(12, 522);
            ...
            // cbTXT
            // 
            this.cbTXT.Location = new System.Drawing.Point(208, 481);
            ...
            this.cbCR.Location = new System.Drawing.Point(280, 481);
            this.cbCR.Name = "cbCR";
            ...
            this.gbFilter.Location = new System.Drawing.Point(278, 8);
            ...
            this.Name = "MittalEmpoyeeAnaliticReport";
		...
		*/
		...
		{        
			...
			public int Compare(EmployeeTO x, EmployeeTO y)        
			{
				...
				switch(compField)            
				{                
					case MittalEmpoyeeAnaliticReport.FirstNameIndex:
						return empl1.FirstName.CompareTo(empl2.FirstName);
					case MittalEmpoyeeAnaliticReport.LastNameIndex:
						return empl1.LastName.CompareTo(empl2.LastName);
					case MittalEmpoyeeAnaliticReport.WorkingUnitIDIndex:
		...
		private void EmployeeReports_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				sortField = MittalEmpoyeeAnaliticReport.LastNameIndex;
				startIndex = 0;						
		...
		private void btnGenerate_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				// Job
				// Pass Types : Regular work and official out
				foreach (IOPairTO iopairTO in ioPairList)
				{
					if ((iopairTO.PassTypeID.Equals(Constants.regularWork)) 
						|| (iopairTO.PassTypeID.Equals(Constants.officialOut)))
					{
				...
				// Private Out
				Hashtable privateOut = new Hashtable();
				...
				while (date <= dtpToDate.Value.Date)
				{
					...
					foreach(IOPairTO pair in ioPairList)
					{
						if (date.Equals(pair.IOPairDate))
						{
							...
							{
                                if (privateOut.ContainsKey(date))
                                {
                                    if (((IOPairTO)(privateOut[date])).StartTime.TimeOfDay > pair.StartTime.TimeOfDay)
                                    {
                                        privateOut[date] = pair.EndTime.TimeOfDay - pair.StartTime.TimeOfDay;
                                    }
                                }
                                else
                                {
                                    privateOut.Add(date, (pair.EndTime.TimeOfDay - pair.StartTime.TimeOfDay));
                                }
							}
						}
					}
				...
				while (date <= dtpToDate.Value.Date)
				{
						...
						job.ContainsKey(date) || overtime.ContainsKey(date) || datesList.Contains(date))
					{
					    ...
					    rowCR["employee_id"] = lvEmployees.SelectedItems[0].Tag;
						// Date
						...
						if (privateOut.ContainsKey(date))
						{
							totalTime = ((TimeSpan) privateOut[date]);
							//row.Add(totalTime.Hours.ToString() + "h " + totalTime.Minutes + "min");
							//totalOverTime = totalOverTime.Add(totalTime);
							rowCR["private_out"] = totalTime.TotalMinutes;
						}
						else
						{
							row.Add("0h 0min");
						...
						if (((rowCR["total_time"] != DBNull.Value) && ((Convert.ToInt32(rowCR["total_time"]) != 0))) ||
							((rowCR["extra_hours"] != DBNull.Value) && ((Convert.ToInt32(rowCR["extra_hours"]) != 0))) ||
							((rowCR["late"] != DBNull.Value) && ((Convert.ToInt32(rowCR["late"]) != 0))) ||
							((rowCR["private_out"] != DBNull.Value) && ((Convert.ToInt32(rowCR["private_out"]) != 0))))
						{
                            rowCR["imageID"] = 1;
                            if (i == 0)
                            {
		...
		private void generateCRReport(DataSet dataCR)
		{
			try
			{
				...
				if (NotificationController.GetLanguage().Equals(Constants.Lang_sr))
				{
					...
					Mittal.Mittal_sr.MittalEmplAnalyticalCRView_sr view = 
						new Mittal.Mittal_sr.MittalEmplAnalyticalCRView_sr(dataCR, dtpFromDate.Value, dtpToDate.Value);
					view.ShowDialog(this);
				}
				else if(NotificationController.GetLanguage().Equals(Constants.Lang_en))
				{
					Mittal.Mittal_en.MittalEmplAnalyticalCRView_en view = 
						new Mittal.Mittal_en.MittalEmplAnalyticalCRView_en(dataCR, dtpFromDate.Value, dtpToDate.Value);
					view.ShowDialog(this);
				}
															}
			catch(Exception ex)
