...
{
	/// <summary>
	/// Summary description for MillenniumEmpoyeeAnaliticReport.
	/// </summary>
	public class MillenniumEmpoyeeAnaliticReport : System.Windows.Forms.Form
	{
		...
		public MillenniumEmpoyeeAnaliticReport()
		{	
			InitializeComponent();
		...
		private void InitializeComponent()
		{
            ...
            // gbEmpolyee
            // 
            this.gbEmpolyee.Controls.Add(this.chbShowRetired);
            ...
            this.gbTimeInterval.Location = new System.Drawing.Point(8, 374);
            ...
            this.lvEmployees.Location = new System.Drawing.Point(8, 142);
            ...
            this.chbCSV.Location = new System.Drawing.Point(232, 486);
            ...
            // btnCancel
            // 
            this.btnCancel.Location = new System.Drawing.Point(264, 526);
            ...
            // btnGenerate
            // 
            this.btnGenerate.Location = new System.Drawing.Point(88, 526);
            ...
            // btnNext
            // 
            this.btnNext.Location = new System.Drawing.Point(432, 110);
            ...
            // btnPrev
            // 
            this.btnPrev.Location = new System.Drawing.Point(392, 110);
            ...
            // cbTXT
            // 
            this.cbTXT.Location = new System.Drawing.Point(312, 486);
            ...
            this.cbCR.Location = new System.Drawing.Point(392, 486);
            this.cbCR.Name = "cbCR";
            ...
            this.chbShowRetired.Location = new System.Drawing.Point(120, 50);
            ...
            // 
            // MillenniumEmpoyeeAnaliticReport
            // 
            ...
            this.Name = "MillenniumEmpoyeeAnaliticReport";
            this.ShowInTaskbar = false;
            this.Text = "Employees Reports";
            this.Load += new System.EventHandler(this.EmployeeReports_Load);
            this.KeyUp += new System.Windows.Forms.KeyEventHandler(this.MillenniumEmpoyeeAnaliticReport_KeyUp);
		...
		*/
		...
		{        
			...
			public int Compare(EmployeeTO x, EmployeeTO y)        
			{
				...
				switch(compField)            
				{                
					case MillenniumEmpoyeeAnaliticReport.FirstNameIndex:
						return empl1.FirstName.CompareTo(empl2.FirstName);
					case MillenniumEmpoyeeAnaliticReport.LastNameIndex:
						return empl1.LastName.CompareTo(empl2.LastName);
					case MillenniumEmpoyeeAnaliticReport.WorkingUnitIDIndex:
		...
		private void EmployeeReports_Load(object sender, System.EventArgs e)
		{
            try
            {
                ...
                sortField = MillenniumEmpoyeeAnaliticReport.LastNameIndex;
                startIndex = 0;
			...
			try
			{
				...
				{					
					if (job.ContainsKey(date))
					{
                        ...
                        //if time schema doesn't exist set 8h
		...
		*/
		...
		private void generateCRReport(DataSet dataCR)
		{
			try
			{
				...
				{
                    Millennium.Millennium_sr.MillenniumEmployeeAnalyticalCRView view = new Millennium.Millennium_sr.MillenniumEmployeeAnalyticalCRView(
						dataCR, dtpFromDate.Value, dtpToDate.Value);
					view.ShowDialog(this);
				}
				else if(NotificationController.GetLanguage().Equals(Constants.Lang_en))
				{
                    Millennium.Millennium_en.MillenniumEmployeeAnalyticalCRView_en view = new Millennium.Millennium_en.MillenniumEmployeeAnalyticalCRView_en(
						dataCR, dtpFromDate.Value, dtpToDate.Value);
					view.ShowDialog(this);
				}
															}
        ...
        private void MillenniumEmpoyeeAnaliticReport_KeyUp(object sender, KeyEventArgs e)
        {
            this.Cursor = Cursors.WaitCursor;
            try
            {
            ...
            {
                log.writeLog(DateTime.Now + " MillenniumEmpoyeeAnaliticReport.MillenniumEmpoyeeAnaliticReport_KeyUp(): " + ex.Message + "\n");
                MessageBox.Show(ex.Message);
            }
            finally
            {
