...
namespace Reports.EUNET.EUNET_en
{
	...
	/// </summary>
	public class EmployeePresenceTypeAnaliticCRView_en : System.Windows.Forms.Form
	{
		...
		public EmployeePresenceTypeAnaliticCRView_en(DataSet Data, DateTime from, DateTime to)
		{
			//
			...
			Reports_en.EmployeePresenceTypeAnaliticCR_en  ecr = new Reports_en.EmployeePresenceTypeAnaliticCR_en();
