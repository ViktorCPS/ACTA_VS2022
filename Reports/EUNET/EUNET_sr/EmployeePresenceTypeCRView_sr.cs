...
namespace Reports.EUNET.EUNET_sr
{
	...
	/// </summary>
	public class EmployeePresenceTypeCRView_sr : System.Windows.Forms.Form
	{
		...
		public EmployeePresenceTypeCRView_sr(DataSet Data, DateTime from, DateTime to)
		{
			//
            ...
            EUNET_sr.EmployeePresenceTypeCR_sr ecr = new EUNET_sr.EmployeePresenceTypeCR_sr();
