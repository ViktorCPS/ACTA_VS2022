...
namespace Reports.EUNET.EUNET_sr
{
	/// <summary>
	/// Summary description for EmployeePresenceTypeCRView_sr.
	/// </summary>
	public class EmployeePresenceTypeAnaliticCRView_sr : System.Windows.Forms.Form
	{
		...
		public EmployeePresenceTypeAnaliticCRView_sr(DataSet Data, DateTime from, DateTime to)
		{
			//
			...
			EUNET_sr.EmployeePresenceTypeAnaliticCR_sr  ecr = new EUNET_sr.EmployeePresenceTypeAnaliticCR_sr();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EmployeePresenceTypeCRView_sr));
