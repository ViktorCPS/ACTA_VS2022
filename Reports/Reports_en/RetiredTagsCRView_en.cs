...
{
	/// <summary>
	/// Summary description for RetiredTagsCRView_en.
	/// </summary>
	public class RetiredTagsCRView_en : System.Windows.Forms.Form
	{
		...
		public RetiredTagsCRView_en(DataSet data)
		{
			//
			...
			RetiredTagsCR_en ecr = new RetiredTagsCR_en();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RetiredTagsCRView_en));
