...
{
	/// <summary>
	/// Summary description for EmployeesCRView_en.
	/// </summary>
	public class EmployeesCRView_en : System.Windows.Forms.Form
	{
		...
		public EmployeesCRView_en(DataSet Data, DateTime from, DateTime to)
		{
			//
			...
			Reports_en.EmployeesCR_en ecr = new Reports_en.EmployeesCR_en();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EmployeesCRView_en));
