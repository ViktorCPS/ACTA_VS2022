...
namespace Reports.Reports_fi
{
	...
	/// </summary>
	public class EmployeePresenceTypeAnaliticCRView_fi : System.Windows.Forms.Form
	{
        ...
        public EmployeePresenceTypeAnaliticCRView_fi(DataSet Data, DateTime from, DateTime to)
		{
			//
            ...
            Reports_fi.EmployeePresenceTypeAnaliticCR_fi ecr = new Reports_fi.EmployeePresenceTypeAnaliticCR_fi();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EmployeePresenceTypeAnaliticCRView_fi));
